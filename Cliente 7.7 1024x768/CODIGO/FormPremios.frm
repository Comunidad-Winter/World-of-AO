...
Private Sub Form_Load()
    ...
    FrmPremios.Picture = LoadPicture(DirGraficos & "ventanas2.jpg")
    ...
    For n = 0 To 33
        ...
        If Premios.MataNPCs(n + 1) > 24 Then
            ...
            FrmPremios.Imagen(n).Picture = LoadPicture(DirGraficos & "\Logros\" & NombreLogro(n + 1))
            ...
            Case 100 To 249
                FrmPremios.Image1(n).Picture = LoadPicture(DirGraficos & "\Logros\t3.bmp")
            ...
            Case 250 To 449
                ...
                FrmPremios.Image1(n).Picture = LoadPicture(DirGraficos & "\Logros\t2.bmp")
            Case Is > 500
                FrmPremios.Image1(n).Picture = LoadPicture(DirGraficos & "\Logros\t1.bmp")
