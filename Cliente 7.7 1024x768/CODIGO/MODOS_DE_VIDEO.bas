...
Function SoportaDisplay(DD As DirectDraw7, DDSDaTestear As DDSURFACEDESC2) As Boolean
    ...
    Do While loopc <> DDEM.GetCount And Not flag
        ...
        flag = ddsd.lHeight = DDSDaTestear.lHeight And ddsd.lWidth = DDSDaTestear.lWidth And _
               ddsd.ddpfPixelFormat.lRGBBitCount = DDSDaTestear.ddpfPixelFormat.lRGBBitCount
        loopc = loopc + 1
    Loop
    SoportaDisplay = flag
...
Function ModosDeVideoIguales(dd1 As DDSURFACEDESC2, dd2 As DDSURFACEDESC2) As Boolean
    ModosDeVideoIguales = dd1.lHeight = dd2.lHeight And dd1.lWidth = dd2.lWidth And dd1.ddpfPixelFormat.lRGBBitCount _
