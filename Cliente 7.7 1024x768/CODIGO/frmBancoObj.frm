...
Begin VB.Form frmBancoObj 
   ...
   Begin VB.ListBox List1 
      ...
      Index           =   1
      Left            =   3600
      MouseIcon       =   "frmBancoObj.frx":1D47F
   ...
   Begin VB.ListBox List1 
      ...
      Index           =   0
      Left            =   240
      MouseIcon       =   "frmBancoObj.frx":1E149
      MousePointer    =   99  'Custom
      TabIndex        =   0
      Top             =   1560
      Width           =   3090
   ...
   Begin VB.Image Image1 
      ...
      Index           =   1
      Left            =   3840
      MouseIcon       =   "frmBancoObj.frx":1EE13
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   2415
   End
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   600
      MouseIcon       =   "frmBancoObj.frx":1FADD
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   2415
   End
   Begin VB.Image Image2 
      ...
      Height          =   375
      Left            =   2520
      MouseIcon       =   "frmBancoObj.frx":207A7
      MousePointer    =   99  'Custom
      Top             =   6600
      Width           =   1815
   End
...
Private Sub List1_Click(index As Integer)
    ...
    Case 0
        ...
        Case 3
            ...
            Label1(4).Caption = "Defensa:" & UserInventory(List1(0).ListIndex + 1).DefMin & "/" & _
                                UserInventory(List1(0).ListIndex + 1).DefMax
    ...
    Case 1
        ...
        Case 3
            Label1(3).Visible = False
            Label1(4).Caption = "Defensa:" & UserInventory(List1(1).ListIndex + 1).DefMin & "/" & _
                                UserInventory(List1(1).ListIndex + 1).DefMax
