...
Begin VB.Form frmCrearPersonaje 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Para más información sobre razas y clases pulsa"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
    ...
    Case 0
        ...
        Case "Elfo"
            ...
            If UserClase = "Guerrero" Or UserClase = "Cazador" Or UserClase = "Pirata" Or UserClase = _
               "Bandido" Or UserClase = "Ladron" Or UserClase = "Leñador" Or UserClase = "Ermitaño" Or _
...
Private Sub lstProfesion_Click()
    ...
    Me.Pdañoproyec.Caption = Round(Me.Pdañoproyec.Caption + porcentaje(Me.Pdañoproyec.Caption, Val( _
                                                                                               lblDañoProye.Caption)))
    'defensa fisica
...
'pluto:2.17
    ...
    Case "ELFO OSCURO"
        ...
        'LabelBonus(4).Caption = "+1"
        Label1.Caption = _
        "Elfos Oscuros: Dope de Agilidad permanente. Invisibilidad +33% duración y obtiene +10 en Evasión."
        Label5.Caption = "Dungeon Newbie"
    ...
    Case "ABISARIO"
        Label5.Caption = "Dungeon Newbie"
        Label1.Caption = "Abisarios: Golpes críticos x1.25 a otros jugadores (1/15). Además 10% de quedar con 1 de vida al recibir golpe y no morir."
