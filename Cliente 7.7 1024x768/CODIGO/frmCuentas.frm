...
'  frmMain.Flash6.Play
    ...
    If FileExist(s, vbHidden) Or FileExist(s8, vbHidden) Then
        ...
        'SendData ("BO3")
        'MsgBox ("Esta Pc ha sido bloqueada para jugar Aodrag, aparecerás en este Mapa cada vez que juegues, avisa Gm para desbloquear la Pc y portate bién o atente a las consecuencias.")
    End If
