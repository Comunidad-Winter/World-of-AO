...
If Op(0).value = False And Op(1).value = False And Op(2).value = False And Op(3).value = False Then
    AddtoRichTextBox frmMain.RecTxt, "Seleccionar una opción.", 255, 255, 255, 1, 1
    'Mensaje.Escribir "Seleccionar una opción."
    Exit Sub
End If
If Len(txtMotivo) > 250 Then
    AddtoRichTextBox frmMain.RecTxt, "Máximo 250 caracteres.", 255, 255, 255, 1, 1
...
If Op(2).value = True And Len(txtMotivo) < 50 Then
    ...
    AddtoRichTextBox frmMain.RecTxt, "Escribi un minimo de 50 caracteres explicando el bug.", 255, 255, 255, 1, 1
    Exit Sub
ElseIf Op(2).value Then
        Call SendData("#" & DarIndiceElegido & "," & txtMotivo)
        Debug.Print "Mande SOS"
    AddtoRichTextBox frmMain.RecTxt, "Gracias por reportar.", 255, 255, 255, 1, 1
...
If Op(1).value = True Then
    ...
    AddtoRichTextBox frmMain.RecTxt, "Utiliza esto solo de urgencia, por ejemplo denunciar chiters o anti faccion.", 255, 255, 255, 1, 1
...
If Op(0).value = True Then
    'Mensaje.msg "¡Tu consulta a sido enviada!"
    AddtoRichTextBox frmMain.RecTxt, "¡Tu consulta a sido enviada!", 255, 255, 255, 1, 1
...
If Len(txtMotivo) = 250 Then
    ...
    AddtoRichTextBox frmMain.RecTxt, "Tamaño maximo 250 caracteres.", 255, 255, 255, 1, 1
End If
End Sub
