...
'Cargamos la interfase
    SELECI = 0
    frmMontura.Picture = LoadPicture(DirGraficos & "mascotas2.jpg")
    ...
    Call DrawGrhtoHdc(Picture1.hwnd, Picture1.hdc, 17800, SR, DR)
    Call DrawGrhtoHdc(Picture2.hwnd, Picture2.hdc, 18495, SR, DR)
    Call DrawGrhtoHdc(Picture3.hwnd, Picture3.hdc, 18496, SR, DR)
    Call DrawGrhtoHdc(Picture4.hwnd, Picture4.hdc, 18497, SR, DR)
    Call DrawGrhtoHdc(Picture5.hwnd, Picture5.hdc, 18718, SR, DR)
    Call DrawGrhtoHdc(Picture6.hwnd, Picture6.hdc, 26936, SR, DR)
    Call DrawGrhtoHdc(Picture7.hwnd, Picture7.hdc, 26940, SR, DR)
    Call DrawGrhtoHdc(Picture8.hwnd, Picture8.hdc, 3809, SR, DR)
    Call DrawGrhtoHdc(Picture9.hwnd, Picture9.hdc, 65, SR, DR)
    Call DrawGrhtoHdc(Picture10.hwnd, Picture10.hdc, 67, SR, DR)
    Call DrawGrhtoHdc(Picture11.hwnd, Picture11.hdc, 66, SR, DR)
    Call DrawGrhtoHdc(Picture12.hwnd, Picture12.hdc, 26942, SR, DR)
...
Private Sub Picture10_MouseMove(Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
...
Private Sub Picture11_MouseMove(Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
...
Private Sub Picture12_MouseMove(Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
...
Private Sub Picture4_MouseMove(Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
...
Private Sub Picture6_MouseMove(Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
...
Private Sub Picture7_MouseMove(Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
...
Private Sub Picture8_MouseMove(Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
...
Private Sub Picture9_MouseMove(Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
