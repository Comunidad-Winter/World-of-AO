...
Begin VB.Form frmParty 
   ...
   Begin VB.Image Image3 
      Height          =   300
      Left            =   3840
      MouseIcon       =   "frmParty.frx":8674
      MousePointer    =   99  'Custom
      Picture         =   "frmParty.frx":933E
      Top             =   3840
      Width           =   1650
   End
   Begin VB.Image Image2 
      Height          =   300
      Left            =   600
      MouseIcon       =   "frmParty.frx":E140
      MousePointer    =   99  'Custom
      Picture         =   "frmParty.frx":EE0A
      Top             =   4440
      Width           =   1650
   End
   Begin VB.Image Image1 
      Height          =   525
      Left            =   600
      MouseIcon       =   "frmParty.frx":13F85
      MousePointer    =   99  'Custom
      Picture         =   "frmParty.frx":14C4F
      Top             =   3840
      Width           =   1485
   End
...
'quitamos el usuario a la lista de miembros
    If Right$(frmParty.List1.List(frmParty.List1.ListIndex), Len(List1.List(frmParty.List1.ListIndex)) - 1) = _
       UserName Then Exit Sub
...
Private Sub Form_Load()
    frmParty.Picture = LoadPicture(DirGraficos & "ventanas.jpg")
    Dim pt1 As Byte
