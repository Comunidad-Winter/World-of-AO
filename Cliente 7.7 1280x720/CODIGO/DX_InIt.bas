...
Private Sub IniciarDDobject(DD As DirectDraw7)
    ...
    If Err Then
        MsgBox _
                "No se puede iniciar DirectDraw. Por favor ejecute DRAG-PROBLEMAS.EXE que se encuentra en la carpeta de AodraG para solucionar su problema, si tiene Windows Vista no olvide dar botón derecho de ratón y ejecutar como administrador."
...
toto:
    ...
    If Resolu = 1 Then    'cambia a 800x600
        If oldResWidth <> 1280 Or oldResHeight <> 720 Then
