...
Sub Sintechos()
    GrhData(7231).FileNum = 11100
    GrhData(7232).FileNum = 11101
    GrhData(643).FileNum = 11102
    GrhData(644).FileNum = 11103
    GrhData(647).FileNum = 11104
    GrhData(5591).FileNum = 11105
    GrhData(5598).FileNum = 11106
    GrhData(5601).FileNum = 11107
    GrhData(7000).FileNum = 11108
    GrhData(7001).FileNum = 11109
    GrhData(7002).FileNum = 11110
    GrhData(7222).FileNum = 11112
    GrhData(7223).FileNum = 11113
    GrhData(7225).FileNum = 11114
    GrhData(7224).FileNum = 11115
    GrhData(7226).FileNum = 11116

    For n = 9141 To 9156
        GrhData(n).FileNum = 11117
    Next

    For n = 9157 To 9172
        GrhData(n).FileNum = 11118
    Next

    For n = 9189 To 9192
        GrhData(n).FileNum = 11120
    Next

    GrhData(9141).FileNum = 7523
