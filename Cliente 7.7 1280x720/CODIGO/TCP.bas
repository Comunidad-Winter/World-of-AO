...
nu:
        ...
        Case 31
            ...
            '    Case Talar
            '        Call AddtoRichTextBox(frmMain.RecTxt, "Haz click sobre el árbol...", 255, 0, 0, 0, 0)
            '    Case Mineria
...
nu4:
        ...
        Case 50
            ...
            'Si todavía no he pasado por aquí...
        ...
        Case 91
            ...
            If Tpj = 2 Then frmTorneoParticipar.Label7.Caption = "15 de Cárcel": _
                    frmTorneoParticipar.Label7.ForeColor = vbRed
        ...
        Case 101
            Call AddtoRichTextBox(frmMain.RecTxt, "Regalo de los Dioses!! 40% extra de Experiencia todo el día.", _
                                  0, 128, 191, True, False, False)
            Exit Sub

        Case 102
            Call AddtoRichTextBox(frmMain.RecTxt, "Regalo de los Dioses!! Hoy Piñatas de Regalo!! ", 0, 128, 191, _
                                  True, False, False)
            Exit Sub
...
'pluto:6.8
    ...
    Case "E1"
        Call AddtoRichTextBox(frmMain.RecTxt, "Estás obstruyendo la via publica, muevete o seras encarcelado!!!", _
                              32, 151, 223, 0, 0)
        Call audio.PlayWave("178.wav")
        Exit Sub

    Case "E2"
        Call AddtoRichTextBox(frmMain.RecTxt, "Estás bloqueando un objeto muevete o serás encarcelado!!!", 32, _
                              151, 223, 0, 0)
        Call audio.PlayWave("178.wav")
        Exit Sub
    ...
    Case "L4"
        Call AddtoRichTextBox(frmMain.RecTxt, _
                              "Primero tenes que seleccionar un Personaje, haz click con el boton izquierdo sobre él.", 64, 64, _
                              128, 0, 0)
        Exit Sub
    ...
    Case "J4"
        Call AddtoRichTextBox(frmMain.RecTxt, _
                              "No puedes usar ese objeto, revisa en nuestro Manual Web el uso de los objetos según la Clase, Raza, facción y sus Puntos Requeridos en Habilidades para ser usados.", _
                              255, 255, 255, 0, 0)
        Exit Sub
    ...
    Case "P1"
        Call AddtoRichTextBox(frmMain.RecTxt, _
                              "Sólo un Domador de Gran Experiencia puede domar este tipo de criaturas.", 87, 87, 87, 0, 0)
        Exit Sub
    ...
    Case "I2"
        MsgBox ( _
               "Esta Pc ha sido bloqueada para jugar World Of AO, aparecerás en este Mapa cada vez que juegues, avisa Gm para desbloquear la Pc y portate bién o atente a las consecuencias.")
        Exit Sub
    ...
    Case "DD"
        ...
        Case "D1A"
            Call AddtoRichTextBox(frmMain.RecTxt, "Seguro de golpes críticos desactivado.", 255, 128, 64, _
                                  True, False, False)
            Exit Sub

        Case "D2A"
            Call AddtoRichTextBox(frmMain.RecTxt, "Seguro de golpes críticos activado.", 255, 128, 64, True, _
                                  False, False)
            Exit Sub

        Case "D3A"
            Call AddtoRichTextBox(frmMain.RecTxt, _
                                  "No puede haber más de 10 niveles de diferencia con respecto al lider de la party.", 64, _
                                  64, 255)
            Exit Sub
        ...
        Case "D16"
            Call AddtoRichTextBox(frmMain.RecTxt, _
                                  "La cola de solicitudes está llena, no puedes unirte en este momento.", 64, 64, 255)
            Exit Sub
        ...
        Case "D25"
            Call AddtoRichTextBox(frmMain.RecTxt, "No estás invitado a ninguna party. Envia una solicitud.", _
                                  64, 64, 255)
            Exit Sub
    ...
    Case "U2"    ' <<--- El user ataco un npc e impacato
        ...
        If Val(ReadField(2, Rdata, 44)) > 0 Then
            Call AddtoRichTextBox(frmMain.RecTxt, "Tu mascota causa " & ReadField(2, Rdata, 44) & _
                                                  " Puntos de Daño.", 0, 94, 0, True, False, False)
        ...
        Call AddtoRichTextBox(frmMain.RecTxt, "Causas " & Val(ReadField(1, Rdata, 44)) & " Puntos de Daño a " & _
