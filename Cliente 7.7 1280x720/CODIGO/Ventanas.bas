        ...
        If IsWindowVisible(hwnd) Then
            ...
            If Len(sTitulo) Then
                ...
                If InStr(1, VentP(Bu), "Cheat Engine") Then
                    ...
                    MsgBox _
                            "Cheat Engine Detectado!!. Ha quedado registrado este intento de usar un Cheat, si vemos que vuelves intentarlo serán baneados todos tus personajes. ¡¡ ESTAS AVISADO !!"
                    End
