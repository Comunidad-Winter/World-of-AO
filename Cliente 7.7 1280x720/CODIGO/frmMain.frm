...
Begin VB.Form frmMain 
   ...
   Begin VB.ListBox ListadoQuest 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   1200
      ItemData        =   "frmMain.frx":919C9
      Left            =   360
      List            =   "frmMain.frx":919CB
      TabIndex        =   59
      Top             =   6240
      Width           =   2535
   End
   ...
   Begin VB.ListBox Chats 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   255
      ItemData        =   "frmMain.frx":92714
      Left            =   13440
      List            =   "frmMain.frx":92716
      MouseIcon       =   "frmMain.frx":92718
      MousePointer    =   99  'Custom
      TabIndex        =   47
      Top             =   10080
      Visible         =   0   'False
   ...
   Begin VB.PictureBox picInv 
      ...
      Height          =   2880
      Left            =   15720
      MouseIcon       =   "frmMain.frx":934DC
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":941A6
      ScaleHeight     =   192
      ScaleMode       =   0  'User
      ScaleWidth      =   192
      TabIndex        =   8
   ...
   Begin VB.Image Image6 
      Height          =   300
      Left            =   3000
      MouseIcon       =   "frmMain.frx":C4DA9
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":C5A73
   ...
   Begin VB.Image Fortaleza 
      Height          =   225
      Left            =   15240
      MouseIcon       =   "frmMain.frx":C5F65
      Picture         =   "frmMain.frx":C6C2F
   ...
   Begin VB.Image Norte 
      Height          =   225
      Left            =   15240
      MouseIcon       =   "frmMain.frx":C6EC9
      Picture         =   "frmMain.frx":C7B93
   ...
   Begin VB.Image DesInv 
      ...
      Index           =   1
      Left            =   18720
      MouseIcon       =   "frmMain.frx":CA48B
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":CB155
      Stretch         =   -1  'True
      Top             =   3000
      Visible         =   0   'False
      Width           =   300
   ...
   Begin VB.Image DesInv 
      ...
      Index           =   0
      Left            =   18720
      MouseIcon       =   "frmMain.frx":CB4FD
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":CC1C7
      Stretch         =   -1  'True
      Top             =   5280
      Visible         =   0   'False
      Width           =   300
   ...
   Begin VB.Image Sur 
      Height          =   225
      Left            =   15240
      MouseIcon       =   "frmMain.frx":D9203
      Picture         =   "frmMain.frx":D9ECD
   ...
   Begin VB.Image Este 
      Height          =   225
      Left            =   15600
      MouseIcon       =   "frmMain.frx":DA167
      Picture         =   "frmMain.frx":DAE31
   ...
   Begin VB.Image Oeste 
      Height          =   225
      Left            =   14760
      MouseIcon       =   "frmMain.frx":FCB14
      Picture         =   "frmMain.frx":FD7DE
   ...
   Begin VB.Image luzaviso 
      Height          =   750
      Left            =   12480
      MouseIcon       =   "frmMain.frx":101EAE
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":102B78
...
Private Sub cmdCambiarClave_Click()
    Call AddtoRichTextBox(frmMain.RecTxt, _
                          "Para cambiar tu clave escribe el comando /PASSWD (deja un espacio) a continuación escribe tu nueva clave", _
                          187, 87, 87, 0, 0)
...
Private Sub flash1_FSCommand(ByVal command As String, ByVal args As String)
    ...
    If UCase$(args) = "/BOVEDA" Or UCase$(args) = "/DESCANSAR" Or UCase$(args) = "/MEDITAR" Or UCase$(args) = _
       "/COMERCIAR" Or UCase$(args) = "/ACOMPAÑAR" Or UCase$(args) = "/QUIETO" Then
        Call SendData(args)
...
Private Sub Form_Load()
    ...
    Call AddtoRichTextBox(frmMain.RecTxt, "Guías del juego: https://world-of-ao.fandom.com/es/wiki/World_Of_AO_Wiki", 255, 191, 128, 0, False, _
                          False)
...
Private Sub picInv_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If (Button = vbRightButton) Then
        ...
        If IndiceLabel <> aux Then
            ...
            If ObjData(ob).MaxModificador > 0 Then Lainv = Lainv & vbNewLine & "Efecto Máximo: " & ObjData( _
               ob).MaxModificador
            If ObjData(ob).MinModificador > 0 Then Lainv = Lainv & vbNewLine & "Efecto Mínimo: " & ObjData( _
               ob).MinModificador
            If ObjData(ob).DuracionEfecto > 0 Then Lainv = Lainv & vbNewLine & "Duración Efecto: " & ObjData( _
               ob).DuracionEfecto
            ...
            If ObjData(ob).SkArco > 0 And ObjData(ob).proyectil > 0 Then Lainv = Lainv & vbNewLine & "Skill Mínimo: " _
               & ObjData(ob).SkArco
            If ObjData(ob).SkArma > 0 And ObjData(ob).proyectil = 0 Then Lainv = Lainv & vbNewLine & "Skill Mínimo: " _
               & ObjData(ob).SkArma
            ...
            If ObjData(ob).HechizoIndex > 0 Then
                ...
                If Hechizos(ObjData(ob).HechizoIndex).MaxHP > 0 Then Lainv = Lainv & vbNewLine & "P.Máximo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MaxHP
                If Hechizos(ObjData(ob).HechizoIndex).MinHP > 0 Then Lainv = Lainv & vbNewLine & "P.Mínimo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MinHP
                If Hechizos(ObjData(ob).HechizoIndex).MaxFuerza > 0 Then Lainv = Lainv & vbNewLine & "F.Máximo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MaxFuerza
                If Hechizos(ObjData(ob).HechizoIndex).MinFuerza > 0 Then Lainv = Lainv & vbNewLine & "F.Mínimo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MinFuerza
                If Hechizos(ObjData(ob).HechizoIndex).MaxAgilidad > 0 Then Lainv = Lainv & vbNewLine & "A.Máximo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MaxAgilidad
                If Hechizos(ObjData(ob).HechizoIndex).MinAgilidad > 0 Then Lainv = Lainv & vbNewLine & "A.Mínimo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MinAgilidad
                If Hechizos(ObjData(ob).HechizoIndex).MaxHam > 0 Then Lainv = Lainv & vbNewLine & "H.Máximo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MaxHam
                If Hechizos(ObjData(ob).HechizoIndex).MinHam > 0 Then Lainv = Lainv & vbNewLine & "H.Mínimo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MinHam
                If Hechizos(ObjData(ob).HechizoIndex).MaxSed > 0 Then Lainv = Lainv & vbNewLine & "S.Máximo: " & _
                   Hechizos(ObjData(ob).HechizoIndex).MaxSed
                If Hechizos(ObjData(ob).HechizoIndex).MinSed > 0 Then Lainv = Lainv & vbNewLine & "S.Mínimo: " & _
...
Private Sub Timer1_Timer()
    ...
    If b = 12 Then
        ...
        Call AddtoRichTextBox(frmMain.RecTxt, _
                              "Guías y Tutoriales: https://world-of-ao.fandom.com/es/wiki/World_Of_AO_Wiki", 80, 147, 206, 0, 2)
        b = 0
...
'cada vez que se reciba algo se almacena en una cadena(str_dato_recibido)
    ...
    Case Is = "msg_archivo_recibido":
        ...
        'Debug.Print "Archivo envíado correctamente"
    End Select
