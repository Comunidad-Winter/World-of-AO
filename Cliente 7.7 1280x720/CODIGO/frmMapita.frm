...
Private Sub Form_Load()
    ...
    For n = 1 To 303
        ...
        Case "Ciudad"
            ...
            If (n = 111 Or n = 112) And DueñoEsperanza = 1 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                                 "\Graficos\Real.bmp")
            If (n = 111 Or n = 112) And DueñoEsperanza = 2 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                                 "\Graficos\Caos.bmp")
            If (n = 150 Or n = 151) And DueñoArghal = 1 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                              "\Graficos\Real.bmp")
            If (n = 150 Or n = 151) And DueñoArghal = 2 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                              "\Graficos\Caos.bmp")
            ...
            If (n = 183 Or n = 184) And DueñoLaurana = 1 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                               "\Graficos\Real.bmp")
            If (n = 183 Or n = 184) And DueñoLaurana = 2 Then Option1(n).Picture = LoadPicture(App.Path & _
                                                                                               "\Graficos\Caos.bmp")
