...
Begin VB.Form frmGuildSol 
   ...
   Begin VB.Image Image1 
      Height          =   525
      Left            =   1200
      MouseIcon       =   "frmSolicitud.frx":5E6A
      MousePointer    =   99  'Custom
      Picture         =   "frmSolicitud.frx":6B34
      Top             =   5880
      Width           =   1485
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   $"frmSolicitud.frx":BC43
      BeginProperty Font 
         Name            =   "Courier New"
         Size            =   8.25
         Charset         =   0
...
Private Sub Form_Load()
    frmGuildSol.Picture = LoadPicture(DirGraficos & "ventanas.jpg")
