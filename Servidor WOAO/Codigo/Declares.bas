...
Public HUNGERGAMESQL As Integer
Public CantHungerGames As Integer
Public TerminoHungerGames As Boolean
Public CantidadHungerGames As Integer
'Juegos del Hambre Automatico

'Blood Castle
'Public HUNGERGAMESQL As Integer
Public CantBloodGames As Integer
Public BloodComienzaX As Integer
Public TerminoBloodGames As Boolean
Public CantidadBloodGames As Integer
'Blood Castle
...
Public RetoDisponible As Boolean
Public RetoDoble As RetoDoble
Public Type RetoDoble
Jugador1 As Integer
Jugador2 As Integer
Jugador3 As Integer
Jugador4 As Integer
...
'/// POSICIONES ////
Public Reto1X As Byte
Public Reto1Y As Byte
Public Reto2X As Byte
Public Reto2Y As Byte
Public Reto3X As Byte
Public Reto3Y As Byte
Public Reto4X As Byte
Public Reto4Y As Byte
'///////////////////////////// 2 vs 2 ////////////////////////////////
 
'///////////////////////////// 1 vs 1 ///////////////////////////////
Public AntesMap As Byte
Public AntesX As Byte
Public AntesY As Byte
 
'Variables de volver :P
Public AntesRetoMap1 As Byte
Public AntesRetoX1 As Byte
Public AntesRetoY1 As Byte
Public AntesRetoMap2 As Byte
Public AntesRetoX2 As Byte
Public AntesRetoY2 As Byte
...
'tiempo eze
Public Conteo As Boolean
Public Conteo1 As Boolean
Public Cuenta1 As Integer
Public Cuenta2 As Integer
Public Templo As Byte
Public TimeGuerraX As Integer
Public TiempoMomia As Integer
Public TiempoRegalo As Integer
Public RegaloTermina As Integer
Public BloodComienza As Integer
Public CantHordas As Integer
Public CantAlis As Integer
Public BloodGanan As Integer
Public TimeTorneo As Integer
Public TiempoCaballero As Integer
Public TiempoOscuro As Integer
Public TiempoHunger As Integer
Public TiempoBlood As Integer
Public HungerE As Integer
'tiempo eze
...
'BORRAR
Public Const NPCTYPE_CRAFTER = 45
'BORRAR
...
Public Const Pescado = 1536
Public Const Pescado1 = 1533
Public Const Pescado2 = 1532
Public Const Pescado3 = 1535
Public Const Pescado4 = 1534
Public Const Pescado5 = 1531
...
Public Const XWindow = 23
Public Const YWindow = 15
...
Public Const SND_IMPACTO_ARROW = 203
Public Const SND_IMPACTO_BERSERKER = 204
...
Public Const OBJTYPE_HUEVOS = 43
'<------------------SUB-CATEGORIAS----------------->
...
Public PremiosListD() As tPremiosCanjesD
...
Type UserFlags
    ...
    QueueArena As Integer
    ArenaBattleSlot As Integer

    'pluto:6.8
    AceptoDoble As Boolean
    SuPareja As Integer
    EsperaPareja As Boolean
    EnPareja As Boolean
    Guerra As Boolean
    HungerGames As Boolean 'Juegos del Hambre Automatico
    BloodGames As Boolean
    Intentos As Byte
...
Public Declare Function GenCrC _
                         Lib "crc" _
                             Alias "GenCrc" (ByVal CrcKey As Long, _
                                             ByVal CrcString As String) As Long
