...
Private Const OroRecompenza As Long = 15000 'Oro de Recompenz
Private Const QuestRecompenza As Integer = 40
...
Public Sub EntrarGuerra(ByVal Userindex As Integer)
    ...
    If UserList(Userindex).Faccion.FuerzasCaos = 1 And DifHorda >= 2 Then
    ...
    If UserList(Userindex).Faccion.ArmadaReal = 1 And DifAli >= 2 Then
