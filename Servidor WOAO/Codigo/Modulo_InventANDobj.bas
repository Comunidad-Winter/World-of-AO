...
nada:
    ...
    'eze: drop de piedras
    If UserList(Userindex).Stats.ELV > 29 Then
        If npc.Stats.MaxHP > 9999 Then
        
        
        MiObj.Amount = Round(npc.Stats.MaxHP / 1000)
        MiObj.ObjIndex = 1500
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.Pos.Map = mapi And alea < 100 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 963
        Call TirarItemAlPiso(npc.Pos, MiObj)
   ...
   ' End If
    ...
    If npc.numero = 699 And alea < 10 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1096
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 761 And alea < 18 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1387
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 754 And alea < 18 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1388
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 752 And alea < 18 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1389
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    '------------IRON AO: Drop Gemas---------------
    'Gema Lunar
    If npc.numero = 758 And alea < 18 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 406
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Azul
    If npc.numero = 600 And alea < 18 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 407
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Naranja
    If npc.numero = 677 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 408
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Celeste
    If npc.numero = 623 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 409
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Rosa
    If npc.numero = 553 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 410
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Roja
    If npc.numero = 739 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 411
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Verde
    If npc.numero = 746 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 412
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Gema Violeta
    If npc.numero = 586 And alea < 19 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 413
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 754 And alea < 25 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1056
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 720 And alea < 25 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1037
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.numero = 624 And alea < 20 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1218
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    If npc.NPCtype = DRAGON And alea < 11 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1095
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'pluto:2.11 hobbit
    If npc.numero = 623 And alea < 15 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1015
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'HUEVOS MASCOTAS
    'Unicornio
    If npc.numero = 616 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1529
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Caballo Negro
    If npc.numero = 617 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1520
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Tigre
    If npc.numero = 618 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1528
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Elefante
    If npc.numero = 619 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1522
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Dragon Dorado
    If npc.numero = 620 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1524
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Jabato
    If npc.numero = 669 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1525
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Rinosaurio
    If npc.numero = 672 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1527
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Cerbero
    If npc.numero = 673 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1521
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Wyvern
    If npc.numero = 674 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1530
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Avestruz
    If npc.numero = 675 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1519
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'cambiar solo beta
    'Faraón
    If npc.numero = 611 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 882
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Caballero Helado
    If npc.numero = 633 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 157
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Caballero Oscuro
    If npc.numero = 726 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1241
        Call TirarItemAlPiso(npc.Pos, MiObj)
    ...
    'Dragón Blood Castle
    If npc.numero = 778 And alea < 30 Then
        MiObj.Amount = 1
        MiObj.ObjIndex = 1558
        Call TirarItemAlPiso(npc.Pos, MiObj)
