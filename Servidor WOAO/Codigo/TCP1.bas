...
Sub TCP1(ByVal Userindex As Integer, ByVal rdata As String)
    ...
    Case ";"    'Hablar
        ...
        If UserList(Userindex).flags.TargetNpc > 0 Then
            If Npclist(UserList(Userindex).flags.TargetNpc).NPCtype = 15 And Distancia(Npclist(UserList( _
                                                                                               Userindex).flags.TargetNpc).Pos, UserList(Userindex).Pos) < 12 Then

                If UCase$(rdata) = UCase$(ResTrivial) Then
                    Call SendData(ToPCArea, Userindex, Npclist(UserList(Userindex).flags.TargetNpc).Pos.Map, _
                                  "||5°Muy bien " & UserList(Userindex).Name & " la respuesta era " & ResTrivial & "°" _
                                  & Npclist(UserList(Userindex).flags.TargetNpc).Char.CharIndex)
                    'pluto:2-3-04
                    Call SendData(ToIndex, Userindex, 0, "||Has ganado 2 Puntos de Canje." & "´" & _
    ...
    If Moverse = 1 Then
        ...
        'rdata = Right$(rdata, Len(rdata) - 1)
        If Not UserList(Userindex).flags.Descansar And Not UserList(Userindex).flags.Meditando And UserList( _
           Userindex).flags.Paralizado = 0 Then
        ...
        If UserList(Userindex).Pos.Map > 199 And UserList(Userindex).Pos.Map < 209 Or UserList(Userindex).Pos.Map = 210 Then Exit Sub

        If UserList(Userindex).flags.Oculto = 1 Then
            If UCase$(UserList(Userindex).clase) <> "LADRON" And UCase$(UserList(Userindex).clase) <> "GUERRERO" And _
               UCase$(UserList(Userindex).clase) <> "CAZADOR" And UCase$(UserList(Userindex).clase) <> "ASESINO" _
               And UCase$(UserList(Userindex).clase) <> "ARQUERO" And UCase$(UserList(Userindex).clase) <> _
               "ASESINO" And UCase$(UserList(Userindex).clase) <> "BANDIDO" Then
...
Exit Sub
    ...
    Case "AT"
        ...
        If UserList(Userindex).Invent.WeaponEqpObjIndex = 0 Then
            Call SendData(ToIndex, Userindex, 0, "||¡¡No podes atacar a nadie sin armas." & "´" & _
                                                 FontTypeNames.FONTTYPE_INFO)
            Exit Sub
        ...
        If UserList(Userindex).Invent.WeaponEqpObjIndex > 0 Then
            If ObjData(UserList(Userindex).Invent.WeaponEqpObjIndex).proyectil = 1 Then
                Call SendData(ToIndex, Userindex, 0, "||No podés usar asi esta arma." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
    ...
    Case "SEG"    'Activa / desactiva el seguro
        ...
        If UserList(Userindex).flags.Seguro Then
            Call SendData(ToIndex, Userindex, 0, "||Has desactivado el seguro que te impide matar Ciudadanos. " & _
                                                 "´" & FontTypeNames.FONTTYPE_talk)
        Else
            Call SendData(ToIndex, Userindex, 0, "||Has activado el seguro que te impide matar Ciudadanos. " & _
                                                 "´" & FontTypeNames.FONTTYPE_talk)
    ...
    Case "REV"    'Activa / desactiva el seguro
        ...
        If UserList(Userindex).flags.SeguroRev Then
            Call SendData(ToIndex, Userindex, 0, "||Has desactivado el seguro Resucitar. " & _
                                                 "´" & FontTypeNames.FONTTYPE_talk)
        Else
            Call SendData(ToIndex, Userindex, 0, "||Has activado el seguro Resucitar. " & _
                                                 "´" & FontTypeNames.FONTTYPE_talk)
    ...
    Case "FINCOMUSU"
        ...
        If UserList(Userindex).ComUsu.DestUsu > 0 And UserList(UserList(Userindex).ComUsu.DestUsu).ComUsu.DestUsu _
           = Userindex Then
            Call SendData(ToIndex, UserList(Userindex).ComUsu.DestUsu, 0, "||" & UserList(Userindex).Name & _
                                                                          " ha dejado de comerciar con vos." & "´" & FontTypeNames.FONTTYPE_COMERCIO)
    ...
    Case "COMUSUNO"
        ...
        If UserList(Userindex).ComUsu.DestUsu > 0 Then
            Call SendData(ToIndex, UserList(Userindex).ComUsu.DestUsu, 0, "||" & UserList(Userindex).Name & _
                                                                          " ha rechazado tu oferta." & "´" & FontTypeNames.FONTTYPE_talk)
            Call FinComerciarUsu(UserList(Userindex).ComUsu.DestUsu)

        End If

        Call SendData(ToIndex, Userindex, 0, "||Has rechazado la oferta del otro usuario." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
        Call FinComerciarUsu(Userindex)
        Exit Sub
        '[/Alejo]
    ...
    Case "P9"
        ...
        'pluto:6.2-----------------------
    Case "B1"
        Call SendData(ToGM, 0, 0, "||Cheat Engine Cerrado en : " & UserList(Userindex).Name & "´" & _
                                  FontTypeNames.FONTTYPE_talk)
        ...
        'pluto:6.2-----------------------
    Case "B2"
        Call SendData(ToGM, 0, 0, "||Fps Bajo: Cerrado Cliente en : " & UserList(Userindex).Name & "´" & _
                                  FontTypeNames.FONTTYPE_talk)
    ...
    Case "TI"    'Tirar item
        ...
        Else
            ...
            If val(Arg1) <= MAX_INVENTORY_SLOTS And val(Arg1) > 0 Then
                ...
                Call DropObj(Userindex, val(Arg1), val(Arg2), UserList(Userindex).Pos.Map, UserList( _
    ...
    Case "NG"    'time
        rdata = Right$(rdata, Len(rdata) - 2)
        Call SendData(ToGM, Userindex, 0, "|| Posible SH en " & UserList(Userindex).Name & " --> " & rdata & "´" _
                                          & FontTypeNames.FONTTYPE_talk)
    ...
    Case "CZ"    'Cambiar Hechizo
        ...
        UserList(Userindex).Stats.UserHechizos(CInt(ReadField(1, rdata, 44))) = UserList( _
                                                                                Userindex).Stats.UserHechizos(CInt(ReadField(2, rdata, 44)))
        ...
        Case 6
            ...
            For LC = 1 To 10
                ...
                If partylist(UserList(Userindex).flags.partyNum).miembros(LC).ID <> 0 Then
                    ...
                    If (tot > 100) Then
                        ...
                        If Tindex > 0 Then
                            Call SendData(ToIndex, Tindex, 0, "||Intento de editar privilegios: " & UserList( _
                                                              Userindex).Name & FONTTYPE_talk)
            ...
            For LC = 1 To 10
                ...
                Else
                    ...
                    If partylist(UserList(Userindex).flags.partyNum).miembros(LC).ID <> 0 Then
                        lcd = lcd + 1
                        partylist(UserList(Userindex).flags.partyNum).miembros(LC).privi = val(ReadField(( _
                                                                                                         lcd), rdata, 44))
    ...
    Case "UK"
        ...
        Case Ocultarse
            ...
            If UserList(Userindex).flags.Navegando = 1 Then
                Call SendData(ToIndex, Userindex, 0, "||No podes ocultarte si estas navegando." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
            ...
            'pluto:2.7.0
            If UserList(Userindex).flags.Morph > 0 Or UserList(Userindex).flags.Demonio > 0 Or UserList( _
               Userindex).flags.Angel > 0 Then Exit Sub
    ...
    Case "IC"
        ...
        'pluto:hoy
    Case "CT"
        Call SendData(ToIndex, Userindex, 0, "||Castillo Norte:" & castillo1 & " Fecha:" & date1 & " Hora:" & _
                                             hora1 & "´" & FontTypeNames.FONTTYPE_INFO)
        Call SendData(ToIndex, Userindex, 0, "||Castillo Sur:" & castillo2 & " Fecha:" & date2 & " Hora:" & hora2 _
                                             & "´" & FontTypeNames.FONTTYPE_INFO)
        Call SendData(ToIndex, Userindex, 0, "||Castillo Este:" & castillo3 & " Fecha:" & date3 & " Hora:" & _
                                             hora3 & "´" & FontTypeNames.FONTTYPE_INFO)
        Call SendData(ToIndex, Userindex, 0, "||Castillo Oeste:" & castillo4 & " Fecha:" & date4 & " Hora:" & _
                                             hora4 & "´" & FontTypeNames.FONTTYPE_INFO)
        Call SendData(ToIndex, Userindex, 0, "||Fortaleza:" & fortaleza & " Fecha:" & date5 & " Hora:" & hora5 & _
                                             "´" & FontTypeNames.FONTTYPE_INFO)
    ...
    Case "DRA"
        ...
        Case "C1"
            ...
            Case "1"
                ...
                If UserList(Userindex).flags.Creditos < 60 Then
                    Call LogDonaciones("Jugador:" & UserList(Userindex).Name & _
                                       " intento estafa dragcreditos: " & " HD: " & UserList(Userindex).Serie)
                    Exit Sub
                ...
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Dragon Color Negro " & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 60
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Dragon Color Rojo " & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "3"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 60
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Dragon Color Azul " & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "4"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 60
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Dragon Color Violeta" & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "5"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 60
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Cambio Color Blanco " & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "C2"
            ...
            Case "1"
                ...
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Unicornio Color Naranja " & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Unicornio Color Rojo " & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "C3"
            ...
            Case "1"
                ...
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Calzones España " & " HD: " _
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 15
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Calzones Argentina " & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "C4"
            ...
            Case "1"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Nick Verde Ciudadano " & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Nick Verde Criminal " & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "C5"
            ...
            Case "1"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Meditar Especial" & " HD: " _
                                   & UserList(Userindex).Serie)
                'meditacion
        ...
        Case "C6"
            ...
            Case "1"
                ...
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Camuflaje Pantera" & " HD: " _
                                   & UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 20
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Camuflaje ciervo" & " HD: " _
                                   & UserList(Userindex).Serie)
            ...
            Case "3"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 20
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Camuflaje Hipopótamo" & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "4"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call WriteVar(UserFile, "FLAGS", "Creditos", val(UserList(Userindex).flags.Creditos))
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Camuflaje Todas" & " HD: " & _
                                   UserList(Userindex).Serie)
        ...
        Case "C7"
            ...
            Case "1"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 15
                UserList(Userindex).GuildInfo.ClanesParticipo = UserList( _
                                                                Userindex).GuildInfo.ClanesParticipo - 1
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " 1 Solicitud de clan" & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                UserList(Userindex).GuildInfo.ClanesParticipo = UserList( _
                                                                Userindex).GuildInfo.ClanesParticipo - 3
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " 3 Solicitud de clan" & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "C8"
            ...
            Case "1"
                ...
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Diamante Sangre" & " HD: " & _
                                   UserList(Userindex).Serie)
            ...
            Case "2"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Túnica Perseus Altos" & _
                                   " HD: " & UserList(Userindex).Serie)
            ...
            Case "3"
                ...
                UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Túnica Perseus Bajos" & _
                                   " HD: " & UserList(Userindex).Serie)
        ...
        Case "4"
            ...
            If UserList(Userindex).flags.Creditos < 30 Then
                Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " intento estafa dragcreditos: " & _
                                   " HD: " & UserList(Userindex).Serie)
                Exit Sub
            ...
            UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
            Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Armadura Perseus Altos" & " HD: " & _
                               UserList(Userindex).Serie)
        ...
        Case "5"
            ...
            UserList(Userindex).flags.Creditos = UserList(Userindex).flags.Creditos - 30
            Call LogDonaciones("Jugador:" & UserList(Userindex).Name & " Armadura Perseus Bajos" & " HD: " & _
                               UserList(Userindex).Serie)
    ...
    Case "JOP"
        rdata = Right$(rdata, Len(rdata) - 3)
        Call LogCasino("Jugador:" & UserList(Userindex).Name & " Clase desconocida desde carp: " & rdata & "Ip: " _
                       & UserList(Userindex).ip)
        Call SendData(ToAdmins, Userindex, 0, "||Clase desconocida: " & UserList(Userindex).Name & "´" & _
    ...
    Case "CNS"    ' Construye herreria
        ...
        If Alarma = 1 Then
            ...
            Call SendData(ToIndex, Userindex, 0, "||¡¡No puedes fabricar tienes el inventario muy lleno!!" & "´" _
                                                 & FontTypeNames.FONTTYPE_COMERCIO)
            Call LogCasino("Jugador:" & UserList(Userindex).Name & " CNS fabricar inventario lleno OBJ: " & X & _
                           "Ip: " & UserList(Userindex).ip)
            Call SendData(ToAdmins, Userindex, 0, "||Fabricando Objeto: " & UserList(Userindex).Name & "´" & _
                                                  FontTypeNames.FONTTYPE_COMERCIO)
...
ur3:
    ...
    Case "CNC"    ' Construye carpinteria
        ...
        If Alarma = 1 Then
            ...
            Call SendData(ToIndex, Userindex, 0, "||¡¡No puedes fabricar tienes el inventario muy lleno!!" & "´" _
                                                 & FontTypeNames.FONTTYPE_COMERCIO)
            Call LogCasino("Jugador:" & UserList(Userindex).Name & " CNC fabricar inventario lleno OBJ: " & X & _
                           "Ip: " & UserList(Userindex).ip)
            Call SendData(ToAdmins, Userindex, 0, "||Fabricando Objeto: " & UserList(Userindex).Name & "´" & _
                                                  FontTypeNames.FONTTYPE_COMERCIO)
...
ur2:
        ...
        If Not IntervaloPermiteTrabajar(Userindex) Then
            Call SendData(ToIndex, Userindex, 0, "||¡¡Debes esperar un poco!!" & "´" & _
                                                 FontTypeNames.FONTTYPE_COMERCIO)
            Exit Sub
    ...
    Case "CER"    'Construye ermitano
        ...
        If Alarma = 1 Then
            ...
            Call SendData(ToIndex, Userindex, 0, "||¡¡No puedes fabricar tienes el inventario muy lleno!!" & "´" _
                                                 & FontTypeNames.FONTTYPE_COMERCIO)
            Call LogCasino("Jugador:" & UserList(Userindex).Name & " CER fabricar inventario lleno OBJ: " & X & _
                           "Ip: " & UserList(Userindex).ip)
            Call SendData(ToAdmins, Userindex, 0, "||Fabricando Objeto: " & UserList(Userindex).Name & "´" & _
                                                  FontTypeNames.FONTTYPE_COMERCIO)
...
ur1:
    ...
    Case "SXS"
        ...
        Call SendData(ToIndex, Tindex, 0, "||Nombre: " & ReadField(2, rdata, 44) & ".exe --> Fecha: " & ReadField( _
                                          3, rdata, 44) & " --> Tamaño: " & ReadField(4, rdata, 44) & "´" & FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||IPCliente: " & ReadField(5, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||NombrePC: " & ReadField(6, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||NúmeroPC: " & ReadField(8, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        ...
        Call SendData(ToIndex, Tindex, 0, "||Engine Instalado al Iniciar: " & ReadField(11, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||Engine Instalado Ahora: " & ReadField(12, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||Engine Cerrados: " & ReadField(10, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        'Delzak)
        Call SendData(ToIndex, Tindex, 0, "||Engine Reciente: " & ReadField(14, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||WPE Reciente: " & ReadField(13, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||Longitud Recientes: " & ReadField(15, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Call SendData(ToIndex, Tindex, 0, "||Versión Windows: " & ReadField(16, rdata, 44) & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
    ...
    Case "BO2"
        ...
        Call SendData(ToIndex, Tindex, 0, "|| " & S & " Seguridad Level 3 sobre ese User" & "´" & _
                                          FontTypeNames.FONTTYPE_talk)
        Exit Sub
    ...
    Case "WLC"    'Click izquierdo en modo trabajo
        ...
        If UserList(Userindex).flags.Muerto = 1 Or UserList(Userindex).flags.Descansar Or UserList( _
           Userindex).flags.Meditando Or Not InMapBounds(UserList(Userindex).Pos.Map, X, Y) Then Exit Sub
        ...
        Case Proyectiles
            ...
            If UserList(Userindex).Invent.MunicionEqpObjIndex = 0 Then
                Call SendData(ToIndex, Userindex, 0, "||No tenes municiones." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
            ...
            'pluto:2.4
            If ObjData(UserList(Userindex).Invent.WeaponEqpObjIndex).Municion <> ObjData(UserList( _
                                                                                         Userindex).Invent.MunicionEqpObjIndex).SubTipo Then
                Call SendData(ToIndex, Userindex, 0, "||Esa Munición no vale para ese arma." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
            ...
            If TU > 0 Then
                If UserList(Userindex).flags.Seguro And MapInfo(UserList(Userindex).Pos.Map).Terreno <> _
                   "TORNEO" And MapInfo(UserList(Userindex).Pos.Map).Terreno <> "EVENTO" And MapInfo(UserList(Userindex).Pos.Map).Terreno <> "CASTILLO" Then    'Delzak añado los castillos
            ...
            If Not ((obj.objetoespecial = 1 And C < 33) Or (obj.objetoespecial = 53 And C < 50) Or ( _
                    obj.objetoespecial = 54 And C < 75)) Then
            ...
            If UserList(Userindex).Invent.Object(DummyInt).Amount > 0 Then
                ...
                UserList(Userindex).Invent.MunicionEqpObjIndex = UserList(Userindex).Invent.Object( _
                                                                 DummyInt).ObjIndex
        ...
        Case Magia
            ...
            If IntervaloPermiteLanzarSpell(Userindex) Then
                Call LookatTile(Userindex, UserList(Userindex).Pos.Map, ReadField(1, rdata, 44), ReadField(2, _
                                                                                                           rdata, 44))
                ...
                Else
                    Call SendData(ToIndex, Userindex, 0, _
                                  "||¡Primero selecciona el hechizo que quieres lanzar!" & "´" & _
                                  FontTypeNames.FONTTYPE_INFO)
        ...
        Case Pesca
            ...
            If UserList(Userindex).Invent.HerramientaEqpObjIndex <> OBJTYPE_CAÑA And UserList( _
               Userindex).Invent.HerramientaEqpObjIndex <> 543 Then
                Call CloseUser(Userindex)
                Exit Sub
            ...
            Else
                Call SendData(ToIndex, Userindex, 0, "||No hay agua donde pescar busca un lago, rio o mar." & _
                                                     "´" & FontTypeNames.FONTTYPE_INFO)
        ...
        Case Robar
            ...
            If MapInfo(UserList(Userindex).Pos.Map).Pk Then
                ...
                If UserList(Userindex).flags.TargetUser > 0 And UserList(Userindex).flags.TargetUser <> _
                   Userindex Then
                    ...
                    If UserList(UserList(Userindex).flags.TargetUser).flags.Muerto = 0 Then
                        ...
                        If MapData(UserList(UserList(Userindex).flags.TargetUser).Pos.Map, UserList(UserList( _
                                                                                                    Userindex).flags.TargetUser).Pos.X, UserList(UserList( _
                                                                                                                                                 Userindex).flags.TargetUser).Pos.Y).trigger = 4 Then
                            Call SendData(ToIndex, Userindex, 0, "||No podes robar aquí." & "´" & _
                ...
                Else
                    Call SendData(ToIndex, Userindex, 0, "||No a quien robarle!." & "´" & _
                                                         FontTypeNames.FONTTYPE_INFO)

                End If

            Else
                Call SendData(ToIndex, Userindex, 0, "||¡No podes robarle en zonas seguras!." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
        ...
        Case Talar
            ...
            If UserList(Userindex).Invent.HerramientaEqpObjIndex = 0 Then
                Call SendData(ToIndex, Userindex, 0, "||Deberías equiparte el hacha." & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
            ...
            If auxind > 0 Then
                ...
                If ObjData(auxind).OBJType = OBJTYPE_ARBOLES Then
                    ...
                    Call SendData(ToPUserAreaCercana, CInt(Userindex), UserList(Userindex).Pos.Map, "TW" & _
                                                                                                    SOUND_TALAR)
            ...
            If ci > 0 Then
                If Npclist(ci).flags.Domable > 0 Then
                    ...
                    If Npclist(ci).flags.AttackedBy <> "" Then
                        Call SendData(ToIndex, Userindex, 0, _
                                      "||No podés domar una criatura que está luchando con un jugador." & "´" & _
                                      FontTypeNames.FONTTYPE_INFO)
                        Exit Sub
                ...
                Else
                    Call SendData(ToIndex, Userindex, 0, "||No podes domar a esa criatura." & "´" & _
                                                         FontTypeNames.FONTTYPE_INFO)
        ...
        Case FundirMetal
            ...
            If UserList(Userindex).flags.TargetObj > 0 Then
                ...
                Else
                    Call SendData(ToIndex, Userindex, 0, "||Ahi no hay ninguna fragua." & "´" & _
                                                         FontTypeNames.FONTTYPE_INFO)
        ...
        Case Herreria
            ...
            If UserList(Userindex).flags.TargetObj > 0 Then
                ...
                Else
                    Call SendData(ToIndex, Userindex, 0, "||Ahi no hay ningun yunque." & "´" & _
                                                         FontTypeNames.FONTTYPE_INFO)
    ...
    Case "CIG"
        ...
        If CreateGuild(UserList(Userindex).Name, 0, Userindex, rdata) Then
            ...
            If X = 0 Then
                Call SendData(ToIndex, Userindex, 0, "||Felicidades has creado el primer clan de Argentum!!!." & _
                                                     "´" & FontTypeNames.FONTTYPE_INFO)
            Else
                Call SendData(ToIndex, Userindex, 0, "||Felicidades has creado el clan numero " & X + 1 & _
                                                     " de Argentum!!!." & "´" & FontTypeNames.FONTTYPE_INFO)
    ...
    Case "INFS"    'Informacion del hechizo
        ...
        If val(rdata) > 0 And val(rdata) < MAXUSERHECHIZOS + 1 Then
            ...
            If H > 0 And H < NumeroHechizos + 1 Then
                Call SendData(ToIndex, Userindex, 0, "||%%%%%%%%%%%% INFO DEL HECHIZO %%%%%%%%%%%%" & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Call SendData(ToIndex, Userindex, 0, "||Nombre:" & Hechizos(H).Nombre & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Call SendData(ToIndex, Userindex, 0, "||Descripcion:" & Hechizos(H).Desc & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Call SendData(ToIndex, Userindex, 0, "||Skill requerido: " & Hechizos(H).MinSkill & " de magia." _
                                                     & "´" & FontTypeNames.FONTTYPE_INFO)
                Call SendData(ToIndex, Userindex, 0, "||Mana necesario: " & Hechizos(H).ManaRequerido & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Call SendData(ToIndex, Userindex, 0, "||%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%" & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
        ...
        Else
            Call SendData(ToIndex, Userindex, 0, "||¡Primero selecciona el hechizo.!" & "´" & _
                                                 FontTypeNames.FONTTYPE_INFO)
    ...
    Case "EQUI"
        ...
        Else
            Call LogCasino("Jugador:" & UserList(Userindex).Name & " entró con cliente modificado. (A)" & "Ip: " _
                           & UserList(Userindex).ip)
            Call SendData(ToAdmins, Userindex, 0, "|| Detectado Cliente Modificado en " & UserList( _
                                                  Userindex).Name & "´" & FontTypeNames.FONTTYPE_talk)
    ...
    Case "SKSE"    'Modificar skills
        ...
        For i = 1 To NUMSKILLS
            ...
            If incremento < 0 Then
                ...
                Call LogHackAttemp(UserList(Userindex).Name & " IP:" & UserList(Userindex).ip & _
                                   " trato de hackear los skills.")
        ...
        For i = 1 To NUMSKILLS
            ...
            If UserList(Userindex).Stats.UserSkills(i) > MAXSKILLPOINTS Then UserList(Userindex).Stats.UserSkills( _
               i) = MAXSKILLPOINTS
        Next i
    ...
    Case "ENTR"    'Entrena hombre!
        ...
        If Npclist(UserList(Userindex).flags.TargetNpc).Mascotas < MAXMASCOTASENTRENADOR Then
            ...
            If val(rdata) > 0 And val(rdata) < 6 Then
                ...
                SpawnedNpc = SpawnNpc(Npclist(UserList(Userindex).flags.TargetNpc).Criaturas(val( _
                                                                                             rdata)).NpcIndex, Npclist(UserList(Userindex).flags.TargetNpc).Pos, True, False)

                'pluto:6.3 cambio <= por <
                If SpawnedNpc < MAXNPCS Then
                    Npclist(SpawnedNpc).MaestroNpc = UserList(Userindex).flags.TargetNpc
                    Npclist(UserList(Userindex).flags.TargetNpc).Mascotas = Npclist(UserList( _
                                                                                    Userindex).flags.TargetNpc).Mascotas + 1
        ...
        Else
            Call SendData(ToPCArea, Userindex, UserList(Userindex).Pos.Map, _
                          "||6°No puedo traer mas criaturas, mata las existentes!°" & str(Npclist(UserList( _
    ...
    Case "COMP"
        ...
        If UserList(Userindex).flags.TargetNpc > 0 Then
            ...
            If Npclist(UserList(Userindex).flags.TargetNpc).Comercia = 0 Then
                Call SendData(ToPCArea, Userindex, UserList(Userindex).Pos.Map, _
                              "||6°No tengo ningun interes en comerciar.°" & str(Npclist(UserList( _
                                                                                         Userindex).flags.TargetNpc).Char.CharIndex))
                Exit Sub
        ...
        Call NPCVentaItem(Userindex, val(ReadField(1, rdata, 44)), val(ReadField(2, rdata, 44)), UserList( _
                                                                                                 Userindex).flags.TargetNpc)
        Exit Sub
    ...
    Case "RETI"
        ...
        If UserList(Userindex).flags.TargetNpc > 0 Then
            ...
            '¿Es el banquero?
            If Npclist(UserList(Userindex).flags.TargetNpc).NPCtype <> 4 And Npclist(UserList( _
    ...
    Case "DEPO"
        ...
        If UserList(Userindex).flags.TargetNpc > 0 Then
            ...
            If Npclist(UserList(Userindex).flags.TargetNpc).NPCtype <> 4 Then
                Call SendData(ToIndex, Userindex, 0, "||¡No puedes soltar objetos en este NPC!" & "´" & _
                                                     FontTypeNames.FONTTYPE_INFO)
                Exit Sub
        ...
        If UserList(Userindex).flags.TargetObj > 0 Then
            ...
            If FileExist(f, vbNormal) Then
                ...
                If num > MAX_MENSAJES_FORO Then
                    ...
                    For loopme = 1 To num
                        Kill App.Path & "\foros\" & UCase$(ObjData(UserList(Userindex).flags.TargetObj).ForoID) & _
                             loopme & ".for"
                    Next
    ...
    Case "OFRECER"
        ...
        'pluto:6.3---------------
        If UserList(UserList(Userindex).ComUsu.DestUsu).flags.Montura > 0 Or UserList(Userindex).flags.Montura > _
           0 Then
            Call FinComerciarUsu(Userindex)
            Exit Sub
        ...
        If UserList(UserList(Userindex).ComUsu.DestUsu).flags.Comerciando = True And UserList(UserList( _
                                                                                              Userindex).ComUsu.DestUsu).ComUsu.DestUsu <> Userindex Then
            Call SendData(ToIndex, Userindex, 0, "||Ya está comerciando con otro user." & "´" & _
                                                 FontTypeNames.FONTTYPE_COMERCIO)
            Call FinComerciarUsu(Userindex)
            Exit Sub
        ...
        Else
            ...
            If val(Arg1) = FLAGORO Then
                ...
                If val(Arg2) > UserList(Userindex).Stats.GLD Then
                    Call SendData(ToIndex, Userindex, 0, "||No tienes esa cantidad." & "´" & _
                                                         FontTypeNames.FONTTYPE_talk)
                    Exit Sub
            ...
            If UserList(UserList(Userindex).ComUsu.DestUsu).ComUsu.DestUsu <> Userindex Then
                ...
                Call SendData(ToIndex, UserList(Userindex).ComUsu.DestUsu, 0, "||" & UserList(Userindex).Name & _
                                                                              " desea comerciar. Si deseas aceptar, Escribe /COMERCIAR." & "´" & _
                                                                              FontTypeNames.FONTTYPE_COMERCIO)
            ...
            Else
                ...
                If UserList(UserList(Userindex).ComUsu.DestUsu).ComUsu.Acepto = True Then
                    ...
                    Call SendData(ToIndex, UserList(Userindex).ComUsu.DestUsu, 0, "||" & UserList(Userindex).Name _
                                                                                  & " HA CAMBIADO SU OFERTA!!." & "´" & FontTypeNames.FONTTYPE_talk)
    ...
    Case "SOLICITUD"
        ...
        If ah < 1 Then
            Call SendData(ToIndex, Userindex, 0, _
                          "||No puedes entrar en más clanes. Realizando las DraG Quest en el NpcQuest puedes ganar una solicitud adicional por cada 20 Quest." _
                          & "´" & FontTypeNames.FONTTYPE_INFO)
            Exit Sub
    ...
    If Left$(rdata, 3) = "BO5" Then
        ...
        Call SendData(ToGM, Tindex, 0, "|| Foto desde la ip: " & UserList(Tindex).ip & "´" & _
                                       FontTypeNames.FONTTYPE_INFO)
    ...
    Exit Sub
ErrorComandoPj:
    Call LogError("TCP1. CadOri:" & CadenaOriginal & " Nom:" & UserList(Userindex).Name & "UI:" & Userindex & " N: " _
