...
Sub CheckIdleUser()
    ...
    For iuserindex = 1 To MaxUsers
        ...
        If UserList(iuserindex).ConnID <> -1 And UserList(iuserindex).flags.UserLogged And UserList( _
           iuserindex).flags.Privilegios = 0 Then
...
Private Sub Auditoria_Timer()
    ...
    SegundosSubasta = SegundosSubasta + 1

    If SegundosSubasta >= 70 Then
        Mod_Subastas.PasarMinutoSubasta
        SegundosSubasta = 0

    End If
    
    Call LogicBattleArena
    ...
    'eze: Torneo
        ...
        Select Case CuentaRegresiva
            ...
            Case 5, 4, 3, 2, 1
                'Call SendData(ToAll, 0, 0, "||Comenzamos en: 5 ´" & FontTypeNames.FONTTYPE_talk)

                'Case 4
                Call SendData(ToAll, 0, 0, "||Comenzamos en: " & CuentaRegresiva & "´" & FontTypeNames.FONTTYPE_talk)

                'Case 3
                'Call SendData(ToAll, 0, 0, "||Comenzamos en: 3 ´" & FontTypeNames.FONTTYPE_talk)

                'Case 2
                'Call SendData(ToAll, 0, 0, "||Comenzamos en: 2 ´" & FontTypeNames.FONTTYPE_talk)

                'Case 1
                'Call SendData(ToAll, 0, 0, "||Comenzamos en: 1 ´" & FontTypeNames.FONTTYPE_talk)
           
            'Case 0
                'Call SendData(ToAll, 0, 0, "||A pelear!!!!!! ´" & FontTypeNames.FONTTYPE_talk)
        End Select
        
        'If CuentaRegresiva = 0 Then Call SendData(ToAll, 0, 0, "||A pelear!!!!!! ´" & FontTypeNames.FONTTYPE_talk)
        ...
        If BloodGanan > 0 Then
        BloodGanan = BloodGanan - 1
        If BloodGanan = 0 Then
        Call BloodGames_Ganan
        End If
        End If
    
        If EmpiezaBlood > 0 Then
        EmpiezaBlood = EmpiezaBlood - 1
        ...
        If CuentaTorneo > 1 Then
            Call SendData(ToAll, 0, 0, "||Inscripciones al Torneo abiertas en ... " & CuentaTorneo - 1)
        Else
            Call SendData(ToAll, 0, 0, "||Inscripciones abiertas.")
            Hay_Torneo = True
            UsuariosEnTorneo = 0
        End If
    ...
    If CuentaAutomatico > 0 Then
        If CuentaAutomatico > 1 Then
            Call SendData(ToAll, 0, 0, "||Inscripciones al Torneo abiertas en ... " & CuentaAutomatico - 1)
        Else
            Call SendData(ToAll, 0, 0, "||Inscripciones abiertas.")
            Torneo_Activo = True
        End If
    ...
    If TimeTorneo > 0 Then
        If TimeTorneo > 1 Then
            Call SendData(ToIndex, UI1, 0, "||El duelo comenzará en... " & TimeTorneo - 1)
            Call SendData(ToIndex, UI2, 0, "||El duelo comenzará en... " & TimeTorneo - 1)
        Else
            Call SendData(ToIndex, UI1, 0, "||A pelear, mucha suerte!!.")
            Call SendData(ToIndex, UI2, 0, "||A pelear, mucha suerte!!.")
            Call SendData2(ToIndex, UI1, 0, 19)
            Call SendData2(ToIndex, UI2, 0, 19)
        End If
        
        TimeTorneo = TimeTorneo - 1
    End If
    ...
    If Cuenta2 > 0 Then
    Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en " & Cuenta2 & " Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
    'If Cuenta2 = 4 Then
    'Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'End If
    
    'If Cuenta2 = 3 Then
    'Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'End If
    
    'If Cuenta2 = 2 Then
    'Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
   ' Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'End If
    
        'If Cuenta2 = 1 Then
    'Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    'End If
    
    If Cuenta2 = 0 Then
    Call SendData(ToIndex, RetoDoble.Jugador1, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador2, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador3, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, RetoDoble.Jugador4, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    ...
    End If
     ...
     If Conteo1 = True Then
    Cuenta1 = Cuenta1 - 1
    
    If Cuenta1 = 5 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 5 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 5 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
    If Cuenta1 = 4 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 4 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
    If Cuenta1 = 3 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 3 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
    If Cuenta1 = 2 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 2 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
        If Cuenta1 = 1 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| El duelo comenzará en 1 Segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    End If
    
    If Cuenta1 = 0 Then
    Call SendData(ToIndex, Pareja.Jugador1, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
    Call SendData(ToIndex, Pareja.Jugador2, 0, "|| Comienza la batalla, buenas suerte." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
...
Private Sub AutoSave_Timer()
    ...
    If MinutoSinMorir = 3 Then
        Call SendData(ToMap, 0, 194, "||Maten a sus rivales o serán todos expulsados de la sala." & "´" & _
        ...
        For i = 1 To MaxUsers
            ...
            If UserList(i).ConnID <> -1 And UserList(i).flags.UserLogged Then
                ...
                If Minotauro = UserList(i).Name Then
                    Call SendData(ToIndex, i, 0, "|| Debes matar al Minotauro antes de " & MinutosMinotauro & _
                                                 " minutos." & "´" & FontTypeNames.FONTTYPE_GUILD)
                ...
                If UserList(i).flags.Muerto = 0 And UserList(i).ObjetosTirados > 15 And UserList(i).ObjetosTirados < _
                   26 Then
                ...
                'pluto:2.14
                If UserList(i).Counters.Pena > 0 Then
                    Call SendData(ToIndex, i, 0, "||Te quedan " & UserList(i).Counters.Pena & " Minutos de Cárcel." & _
                ...
                If UserList(i).Alarma = 2 Then
                    Call SendData(ToGM, i, 0, "||LoG activo sobre " & UserList(i).Name & "´" & _
                                              FontTypeNames.FONTTYPE_talk)
                ...
                If aa > ProbEmbarazo And UserList(i).Amor > 1 And UserList(i).Embarazada = 0 And UCase$(UserList( _
                                                                                                        i).Genero) = "MUJER" And UserList(i).Nhijos < 5 And UserList(Tindex).Nhijos < 5 Then
                    UserList(i).Embarazada = 95
                    Call SendData(ToIndex, i, 0, _
                                  "||Sientes que una vida nueva crece en tu interior. Enhorabuena! estás embarazada." & "´" _
                                  & FontTypeNames.FONTTYPE_talk)
                ...
                If aa > 250 Then
                    ...
                    If Distancia(UserList(i).Pos, UserList(Tindex).Pos) < 16 Then
                        UserList(i).Amor = UserList(i).Amor + 1

                        If UserList(i).Amor > 100 Then UserList(i).Amor = 100
                        Call SendData2(ToPCArea, i, UserList(i).Pos.Map, 22, UserList(i).Char.CharIndex & "," & 88 & _
                                                                             "," & 5)
                    Else
...
fuera3:
                ...
                If UserList(i).Embarazada >= TimeEmbarazo And UserList(i).NombreDelBebe = "" Then
                    Call SendData(ToIndex, i, 0, "||Estás a punto de tener un hijo, ve cuanto antes a una Matrona." & _
                                                 "´" & FontTypeNames.FONTTYPE_talk)
                ...
                If UserList(i).GranPoder > 0 Then
                    ...
                    If UserList(i).Pos.Map = 186 Or MapInfo(UserList(i).Pos.Map).Pk = False Or MapInfo(UserList( _
                                                                                                       i).Pos.Map).Zona = "CLAN" Then
                        MinutosPoder = MinutosPoder + 1

                        If MinutosPoder > 1 Then
                            UserList(i).GranPoder = 0
                            UserGranPoder = ""
                            UserList(i).Char.FX = 0
                            Call SendData2(ToMap, i, UserList(i).Pos.Map, 22, UserList(i).Char.CharIndex & "," & 68 & _
                                                                              "," & 0)
                            MinutosPoder = 0
                        Else
                            Call SendData(ToIndex, i, 0, "|| Estás en zona segura, te quedan " & 4 - MinutosPoder & _
                                                         " minutos para perder el Gran Poder." & "´" & FontTypeNames.FONTTYPE_GUILD)
                ...
                If UserGranPoder = "" And i = tt And UserList(i).flags.Muerto = 0 And UserList(i).flags.Privilegios = _
                   0 And NumUsers > NumeroGranPoder And MapInfo(UserList(i).Pos.Map).Pk = True Then
...
fuera:
            ...
            '-------------------------------------
            'pluto.2.17 norte
            If MinutosCastilloNorte > 30 Then
                ...
                If UserList(i).GuildInfo.GuildName = castillo1 And UserList(i).Stats.ELV > 25 Then
                    ...
                    UserList(i).Stats.Puntos = UserList(i).Stats.Puntos + 2
                    'UserList(i).Stats.GLD = UserList(i).Stats.GLD + Int(rn / 5)
                    Call AddtoVar(UserList(i).Stats.GLD, Int(rn / 60), MAXORO)
                    'pluto:2.4.5

                    Call SendData(ToIndex, i, 0, "|| Has obtenido " & rn & " de Exp y " & Int(rn / 60) & _
                                                 " de Oro por Mantener el Castillo Norte" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido 2 Puntos de Canje por Mantener el Castillo Norte" & "´" & FontTypeNames.FONTTYPE_GUILD)
            ...
            If MinutosCastilloSur > 30 Then
                ...
                If UserList(i).GuildInfo.GuildName = castillo2 And UserList(i).Stats.ELV > 25 Then
                    ...
                    UserList(i).Stats.Puntos = UserList(i).Stats.Puntos + 2
                    Call SendData(ToIndex, i, 0, "|| Has obtenido " & rn & " de Exp y " & Int(rn / 60) & _
                                                 " de Oro por Mantener el Castillo Sur" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido 2 Puntos de Canje por Mantener el Castillo Sur" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "TW" & 105)
                    Call SendUserStatsOro(i)
                    Call CheckUserLevel(i)
                    Call senduserstatsbox(i)
            ...
            'pluto.2.17 ESTE
            If MinutosCastilloEste > 30 Then
                ...
                If UserList(i).GuildInfo.GuildName = castillo3 And UserList(i).Stats.ELV > 25 Then
                    ...
                    Call SendData(ToIndex, i, 0, "|| Has obtenido " & rn & " de Exp y " & Int(rn / 60) & _
                                                 " de Oro por Mantener el Castillo Este" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido 2 Puntos de Canje por Mantener el Castillo Este" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "TW" & 105)
                    Call SendUserStatsOro(i)
                    Call CheckUserLevel(i)
                    Call senduserstatsbox(i)
            ...
            'pluto.2.17 oESTE
            If MinutosCastilloOeste > 30 Then
                'suma puntos clan
                ...
                If UserList(i).GuildInfo.GuildName = castillo4 And UserList(i).Stats.ELV > 25 Then
                    ...
                    Call AddtoVar(UserList(i).Stats.GLD, Int(rn / 60), MAXORO)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido " & rn & " de Exp y " & Int(rn / 60) & _
                                                 " de Oro por Mantener el Castillo Oeste" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido 2 Puntos de Canje por Mantener el Castillo Oeste" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "TW" & 105)
                    Call SendUserStatsOro(i)
                    Call CheckUserLevel(i)
                    Call senduserstatsbox(i)
            ...
            If MinutosFortaleza > 30 Then
                ...
                If UserList(i).GuildInfo.GuildName = fortaleza And UserList(i).Stats.ELV > 25 Then
                    rn = Int(UserList(i).GuildInfo.GuildPoints * 2) + 15000
                    UserList(i).Stats.exp = UserList(i).Stats.exp + rn
                    UserList(i).Stats.Puntos = UserList(i).Stats.Puntos + 3
                    'UserList(i).Stats.GLD = UserList(i).Stats.GLD + Int(rn / 2)
                    Call AddtoVar(UserList(i).Stats.GLD, Int(rn / 50), MAXORO)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido " & rn & " de Exp y " & Int(rn / 50) & _
                                                 " de Oro por Mantener la Fortaleza" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "|| Has obtenido 3 Puntos de Canje por Mantener la Fortaleza" & "´" & FontTypeNames.FONTTYPE_GUILD)
                    Call SendData(ToIndex, i, 0, "TW" & 105)
                    Call SendUserStatsOro(i)
                    Call CheckUserLevel(i)
                    Call senduserstatsbox(i)
            ...
            PuntosC = UserList(i).Stats.Puntos
            Call SendData(ToIndex, i, 0, "J5" & PuntosC)
    ...
    If MinutosCastilloNorte > 30 Then
        ...
        For ii = 1 To Guilds.Count
            ...
            If UCase$(castillo1) = UCase$(Guilds(ii).GuildName) Then
                ...
                Next
                'nati: Calcula la gente online en el Clan
                Guilds(ii).Reputation = Guilds(ii).Reputation + 15
    ...
    If (MinutosLatsClean = 7 Or MinutosLatsClean = 15) And UserGranPoder <> "" Then
        ...
        If Podercito > 0 Then
            Call SendData(ToAll, 0, 0, "|| Gran Poder: " & UserGranPoder & " en Mapa " & UserList(Podercito).Pos.Map _
                                       & "´" & FontTypeNames.FONTTYPE_COMERCIO)
        ...
        If UserList(iuserindex).ConnID <> -1 Then
            ...
            If UserList(iuserindex).ConnIDValida And UserList(iuserindex).flags.UserLogged Then
                ...
                If UserList(iuserindex).Name = "" Or Cuentas(iuserindex).Logged = False Then
                    ...
                    Call LogError("Quitado Clon: " & UserList(iuserindex).Pos.Map & "," & UserList(iuserindex).Pos.X _
                                  & "," & UserList(iuserindex).Pos.Y)
                    Exit Sub
                ...
                'If CuentaRegresiva Then
                 '   If CuentaRegresiva = 200 Then
                  '      Call SendData(ToMap, 0, UserList(indexCuentaRegresiva).Pos.Map, "||Cuenta regresiva: 3 ´" & _
                                                                                        FontTypeNames.FONTTYPE_talk)

                   ' End If

                    'If CuentaRegresiva = 100 Then
                     '   Call SendData(ToMap, 0, UserList(indexCuentaRegresiva).Pos.Map, "||Cuenta regresiva: 2 ´" & _
                                                                                        FontTypeNames.FONTTYPE_talk)

                    'End If

                    'If CuentaRegresiva = 50 Then
                     '   Call SendData(ToMap, 0, UserList(indexCuentaRegresiva).Pos.Map, "||Cuenta regresiva: 1 ´" & _
                                                                                        FontTypeNames.FONTTYPE_talk)
                    ...
                    'If CuentaRegresiva = 1 Then
                     '   MapaSeguro = UserList(indexCuentaRegresiva).Pos.Map
                      '  Call SendData(ToMap, 0, UserList(indexCuentaRegresiva).Pos.Map, "||Mapa Inseguro ´" & _
                                                                                        FontTypeNames.FONTTYPE_talk)
               ...
               ' End If
                    If Not HayGuerra Then
                        If UserList(iuserindex).Pos.Map = 203 Or UserList(iuserindex).Pos.Map = 204 Then
                        Call WarpUserChar(iuserindex, 34, 50, 50, True)
                        End If
                    End If
                    
                    If UserList(iuserindex).flags.Guerra = True Then
                    If Not UserList(iuserindex).Pos.Map > 202 And UserList(iuserindex).Pos.Map < 205 Then
                    UserList(iuserindex).flags.Guerra = False
                    Call SendData(ToIndex, iuserindex, 0, "||Ya no estas en Guerra." & "´" & _
                                                                          FontTypeNames.FONTTYPE_INFO)
                    End If
                    End If
                
                
                    If UserList(iuserindex).GranPoder > 0 Then
                    If MapInfo(UserList(iuserindex).Pos.Map).Terreno = "TORNEO" Or MapInfo(UserList(iuserindex).Pos.Map).Terreno = "EVENTO" Or UserList(iuserindex).Pos.Map = 203 Or _
                     UserList(iuserindex).Pos.Map = 204 Or UserList(iuserindex).Pos.Map = 205 Then
                    UserList(iuserindex).GranPoder = 0
                    UserGranPoder = ""
                    UserList(iuserindex).Char.FX = 0
                    Call SendData2(ToMap, iuserindex, UserList(iuserindex).Pos.Map, 22, UserList(iuserindex).Char.CharIndex & "," & _
                                                                          68 & "," & 0)
                ...
                If UserList(iuserindex).flags.Muerto = 0 Then
                    ...
                    'pluto:6.2
                    If UserList(iuserindex).flags.Macreanda > 0 And UserList(iuserindex).Stats.MinSta > 0 Then Call _
                       EfectoMacrear(iuserindex, UserList(iuserindex).flags.Macreanda)
                    ...
                    If UserList(iuserindex).flags.Ceguera = 1 Or UserList(iuserindex).flags.Estupidez Then Call _
                    ...
                    If UserList(iuserindex).flags.Angel Or UserList(iuserindex).flags.Demonio Then Call QuitarSta( _
                       iuserindex, 2)

                    'pluto:2.9.0
                    If UserList(iuserindex).Char.Body = 9 Or UserList(iuserindex).Char.Body = 260 Or UserList( _
                       iuserindex).Char.Body = 380 Then
                    ...
                    If UserList(iuserindex).flags.AdminInvisible <> 1 And UserList(iuserindex).flags.Invisible = 1 _
                       Then Call EfectoInvisibilidad(iuserindex)
                    ...
                    If UserList(iuserindex).raza = "Vampiro" Then
                        If UserList(iuserindex).Char.Body <> 9 And UserList(iuserindex).Char.Body <> 260 Then
                            ...
                            Else
                                ...
                                If UserList(iuserindex).Stats.MaxHP = UserList(iuserindex).Stats.MinHP And UserList( _
                                   iuserindex).Stats.MaxSta = UserList(iuserindex).Stats.MinSta Then
                                    Call SendData2(ToIndex, iuserindex, 0, 41)
                                    Call SendData(ToIndex, iuserindex, 0, "||Has terminado de descansar." & "´" & _
                                                                          FontTypeNames.FONTTYPE_INFO)
                    ...
                    If Lloviendo Then
                        If Not Intemperie(iuserindex) Then
                            If Not UserList(iuserindex).flags.Descansar And (UserList(iuserindex).flags.Hambre = 0 _
                                                                             And UserList(iuserindex).flags.Sed = 0) Then
                                'No esta descansando
                    ...
                    Else
                        ...
                        If Not UserList(iuserindex).flags.Descansar And (UserList(iuserindex).flags.Hambre = 0 And _
                                                                         UserList(iuserindex).flags.Sed = 0) Then
                            'No esta descansando
                            Call Sanar(iuserindex, bEnviarStats, SanaIntervaloSinDescansar)
...
vampi:
                ...
                Else    'ESTA MUERTO
                    ...
                    ElseIf UserList(iuserindex).Pos.Map = 92 Then
                        Call WarpUserChar(iuserindex, 91, 67, 36, True)
                        'pluto:2-3-04 muere en egipto
                    ElseIf UserList(iuserindex).Pos.Map = 200 Or UserList(iuserindex).Pos.Map = 201 Or UserList(iuserindex).Pos.Map = 202 Then
                    Call WarpUserChar(iuserindex, 47, 58, 21, True)
                    ElseIf UserList(iuserindex).Pos.Map > 177 And UserList(iuserindex).Pos.Map < 183 And UserList( _
                           iuserindex).Pos.Map <> 181 And UserList(iuserindex).flags.Muerto = 1 Then
                        Call WarpUserChar(iuserindex, 181, 42, 66, True)
                        'pluto:6.8 muere castillos sin puntos
                    ElseIf UserList(iuserindex).Pos.Map > 165 And UserList(iuserindex).Pos.Map < 170 And UserList( _
                           iuserindex).Stats.PClan < 0 And UserList(iuserindex).flags.Muerto = 1 Then
...
Private Sub Limpiado_Timer()
    ...
    Case 1
        Call SendData(ToAll, 0, 0, "||%%% NO TIREN OBJETOS AL SUELO, LIMPIADO DE MAPAS EN 15 SEGUNDOS.%%%" & "´" _
                                   & FontTypeNames.FONTTYPE_talk)

    Case 2
        Call SendData(ToAll, 0, 0, "||%%% NO TIREN OBJETOS AL SUELO, LIMPIADO DE MAPAS EN 10 SEGUNDOS.%%%" & "´" _
                                   & FontTypeNames.FONTTYPE_talk)

    Case 3
        Call SendData(ToAll, 0, 0, "||%%% NO TIREN OBJETOS AL SUELO, LIMPIADO DE MAPAS EN 5 SEGUNDOS.%%%" & "´" & _
                                   FontTypeNames.FONTTYPE_talk)
                    ...
                    For Y = 1 To 100
                        For X = 1 To 100
                            ...
                            If X > 0 And Y > 0 And X < 101 And Y < 101 Then
                                If MapData(Mapasatu, X, Y).OBJInfo.ObjIndex > 0 And MapData(Mapasatu, X, _
                                                                                            Y).Blocked = 0 Then
...
Private Sub mnuCierra_Click()
    Call WriteVar(IniPath & "eventodia.txt", "INIT", "Evento", val(EventoDia))
    Call SendData(ToAll, 0, 0, "||%%%% EL SERVICIO TÉCNICO VA REINICIAR LA PC...%%%%" & "´" & _
                               FontTypeNames.FONTTYPE_talk)
            ...
            If Npclist(NpcIndex).flags.NPCActive Then    'Nos aseguramos que sea INTELIGENTE!
                ...
                If Npclist(NpcIndex).NPCtype = 99 Then
                    If MinutosMinotauro <= 0 And EstadoMinotauro = 1 Then
                        EstadoMinotauro = 2
                        Minotauro = ""
                        Call SendData(ToAll, 0, 0, "||El Minotauro no ha sido encontrado y desaparece." & "´" & _
                                                   FontTypeNames.FONTTYPE_PARTY)
                        Call LogCasino("Quitado " & Npclist(NpcIndex).Name & " del mapa: " & Npclist( _
                                       NpcIndex).Pos.Map & " x:" & Npclist(NpcIndex).Pos.X & " y:" & Npclist(NpcIndex).Pos.Y)
...
Private Sub Timer1_Timer()
    ...
    For i = 1 To MaxUsers
        ...
        If UserList(i).flags.UserLogged Then If UserList(i).flags.Oculto = 1 Then Call DoPermanecerOculto(i)
...
Private Sub Timer2_Timer()
    ...
    If TiempoMomia > 0 Then
        TiempoMomia = TiempoMomia - 1
            Call SendData(ToAll, 0, 0, "I3" & TiempoMomia)
        If TiempoMomia = 0 Then
    Dim Momi As WorldPos
    Momi.X = 47
    Momi.Y = 30
    Momi.Map = 182
            Call SpawnNpc(611, Momi, True, False)
            Call SendData(ToAll, 0, 0, "||  Se ha invocado el Faraón en las pirámides del mapa 21, deberás superar el laberinto para llegar a el." & "´" & FontTypeNames.FONTTYPE_pluto)
        End If
    End If
    
        If TiempoRegalo > 0 Then
        TiempoRegalo = TiempoRegalo - 1
            Call SendData(ToAll, 0, 0, "I7" & TiempoRegalo)
        If TiempoRegalo = 0 Then
        Dim Ale As Byte
        Ale = RandomNumber(1, 2)
            EventoDia = Ale
            RegaloTermina = 60
            Call SendData(ToAll, 0, 0, "||  Regalo de los dioses activado!!." & "´" & FontTypeNames.FONTTYPE_pluto)
            If EventoDia = 1 Then Call SendData2(ToAll, 0, 0, 99, NombreBichoDelDia)
            If EventoDia = 2 Then Call SendData2(ToAll, 0, 0, 101)
        End If
    End If
    
        If RegaloTermina > 0 Then
            RegaloTermina = RegaloTermina - 1
                If RegaloTermina = 0 Then
                EventoDia = 0
                Call SendData(ToAll, 0, 0, "||  Regalo de los dioses terminado!!." & "´" & FontTypeNames.FONTTYPE_pluto)
                TiempoRegalo = 480
            End If
        End If
        
        If BloodComienzaX > 0 Then
            Call SendData(ToAll, 0, 0, "|/Blood Castle" & "> " & "Quedan " & BloodComienzaX & _
                               " minutos para ingresar al Blood Castle. /BLOODCASTLE!")
            BloodComienzaX = BloodComienzaX - 1
                If BloodComienzaX = 0 Then
                    Call BloodGames_EntraX
                End If
        End If
    
        If BloodComienza > 0 Then
        BloodComienza = BloodComienza - 1
            Call SendData(ToAll, 0, 0, "I6" & BloodComienza)
        If BloodComienza = 0 Then
        BloodGames_Comienza (10)
    ...
    If TiempoCaballero > 0 Then
        TiempoCaballero = TiempoCaballero - 1
            Call SendData(ToAll, 0, 0, "I4" & TiempoCaballero)
        If TiempoCaballero = 0 Then
    Dim caba As WorldPos
    caba.X = 50
    caba.Y = 60
    caba.Map = 92
            Call SpawnNpc(633, caba, True, False)
            Call SendData(ToAll, 0, 0, "||  Se ha invocado el Caballero Helado en las cavernas del mapa 90, recupera el Santo Grial, serás recompensado." & "´" & FontTypeNames.FONTTYPE_pluto)
        End If
    End If
    
        If TiempoOscuro > 0 Then
        TiempoOscuro = TiempoOscuro - 1
            Call SendData(ToAll, 0, 0, "I5" & TiempoOscuro)
        If TiempoOscuro = 0 Then
    Dim oscu As WorldPos
    oscu.X = 49
    oscu.Y = 34
    oscu.Map = 279
            Call SpawnNpc(726, oscu, True, False)
            Call SendData(ToAll, 0, 0, "||  Se ha invocado el Caballero Oscuro en el mapa, sus esbirros lo protegerán, necesitamos proteger el mundo, la maldad se avecina." & "´" & FontTypeNames.FONTTYPE_pluto)
        End If
    End If
    
    

    'If TiempoHunger > 0 Then
    'TiempoHunger = TiempoHunger - 1
    'End If
        
     '   If TiempoHunger > 5 Then
      '      Call SendData(ToAll, 0, 0, "J7" & TiempoHunger - 5)
      '  Else
       '     Call SendData(ToAll, 0, 0, "J7" & 0)
       ' End If
            
        'If TiempoHunger = 5 Then
         '   HungerGames_Comienza (6)
          '  End If
            
        'If TiempoHunger = 4 Then
         '               Call SendData(ToAll, 0, 0, "|/Juegos del Hambre" & "> " & _
                                                 "Los juegos del hambre estàn a punto de comenzar /HUNGER para participar. Deposita todos tus items para ingresar.")
        'ElseIf TiempoHunger = 3 Then
         '                       Call SendData(ToAll, 0, 0, "|/Juegos del Hambre" & "> " & _
                                                 "Los juegos del hambre estàn a punto de comenzar /HUNGER para participar. Deposita todos tus items para ingresar.")
        'ElseIf TiempoHunger = 2 Then
         '                           Call SendData(ToAll, 0, 0, "|/Juegos del Hambre" & "> " & _
                                                 "Los juegos del hambre estàn a punto de comenzar /HUNGER para participar. Deposita todos tus items para ingresar.")
        'ElseIf TiempoHunger = 1 Then
         '                           Call SendData(ToAll, 0, 0, "|/Juegos del Hambre" & "> " & _
                                                 "Los juegos del hambre estàn a punto de comenzar /HUNGER para participar. Deposita todos tus items para ingresar.")
        'ElseIf TiempoHunger = 0 Then
        'HungerGames_Cancela
        'TiempoHunger = 120
...
Private Sub Torneo_Timer()
    ...
    If TClanOcupado = 1 Then
        ...
        If Vez = 5 Then
            Call SendData(ToAll, 0, 0, "||Nadie aceptó el desafío para el Duelo de Clanes!!" & "´" & _
    ...
    If TClanOcupado = 4 Then
        ...
        Next
        Call SendData(ToClan, 0, 0, "Clan " & TorneoClan(1).Nombre & ": " & MsgTorneo & "´" & _
                                    FontTypeNames.FONTTYPE_pluto)
        ...
        Next
        Call SendData(ToClan, 0, 0, "Clan " & TorneoClan(2).Nombre & ": " & MsgTorneo & "´" & _
                                    FontTypeNames.FONTTYPE_pluto)
        Call SendData(ToClan, 0, 0, "Vayan equipandose en unos instantes serán Teletransportados." & "´" & _
                                    FontTypeNames.FONTTYPE_pluto)
    ...
    If TClanOcupado = 5 Then
        ...
        For n = 1 To TClanNumero
            ...
            If UserList(Tindex).flags.Angel > 0 Or UserList(Tindex).flags.Demonio > 0 Or UserList(Tindex).flags.Morph _
               > 0 Then UserList(Tindex).Stats.MinSta = 0
...
otro2:
    ...
    If TClanOcupado = 6 Then
        ...
        If TorneoClan(1).numero < 1 Then
            ...
            Call SendData(ToAll, 0, 0, "||El Clan " & TorneoClan(2).Nombre & Mensa & TorneoClan(1).Nombre & "!!" & _
                                       "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "El Clan " & TorneoClan(2).Nombre & " ha ganado " & Puntazos1 & _
                                        " Puntos de Clan" & "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "El Clan " & TorneoClan(1).Nombre & " ha pérdido " & Puntazos1 & _
                                        " Puntos de Clan" & "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "En unos instantes serán expulsados de la sala." & "´" & _
                                        FontTypeNames.FONTTYPE_pluto)
            TClanOcupado = 7
            Exit Sub
        ...
        If TorneoClan(2).numero < 1 Then
            ...
            Call SendData(ToAll, 0, 0, "||El Clan " & TorneoClan(1).Nombre & Mensa & TorneoClan(2).Nombre & "!!" & _
                                       "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "El Clan " & TorneoClan(1).Nombre & " ha ganado " & Puntazos2 & _
                                        " Puntos de Clan" & "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "El Clan " & TorneoClan(2).Nombre & " ha pérdido " & Puntazos2 & _
                                        " Puntos de Clan" & "´" & FontTypeNames.FONTTYPE_pluto)
            Call SendData(ToClan, 0, 0, "En unos instantes serán expulsados de la sala." & "´" & _
                                        FontTypeNames.FONTTYPE_pluto)
            TClanOcupado = 7
    ...
    If TClanOcupado = 7 Then
        ...
        For n = 1 To MaxUsers
            ...
            If UserList(n).flags.UserLogged = True Then
                If UserList(n).Pos.Map = 292 Then Call WarpUserChar(n, 34, 50, 50, True)
...
Private Sub tPiqueteC_Timer()
    ...
    For i = 1 To LastUser
        ...
        If UserList(i).flags.UserLogged Then
            ...
            If Casa = 51 Or Casa = 30 Or Casa = 31 Then
                Call SendData(ToIndex, i, 0, "|| Los Espiritus de la Casa te hacen perder Oro." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
            ...
            If Casa = 52 And UserList(i).flags.Morph = 0 And UserList(i).flags.Navegando = 0 And UserList( _
               i).flags.Invisible = 0 And UserList(i).flags.Angel = 0 And UserList(i).flags.Demonio = 0 Then
                UserList(i).flags.Morph = UserList(i).Char.Body
                UserList(i).Counters.Morph = IntervaloMorphPJ
                Call SendData(ToIndex, i, 0, "|| Los Espiritus de la Casa te transforman en Cerdo." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
                '[gau]
                Call ChangeUserChar(ToMap, 0, UserList(i).Pos.Map, i, val(6), val(0), UserList(i).Char.Heading, _
                                    UserList(i).Char.WeaponAnim, UserList(i).Char.ShieldAnim, UserList(i).Char.CascoAnim, _
                                    UserList(i).Char.Botas, UserList(i).Char.AlasAnim)
                Call SendData2(ToPCArea, i, UserList(i).Pos.Map, 22, UserList(i).Char.CharIndex & "," & 33 & "," & 1)
                Call SendData(ToMap, 0, Map, "TW" & 115)
            ...
            If Casa = 53 Then
                Call SendData(ToIndex, i, 0, "|| Los Espiritus de la Casa te teleportan fuera de ella." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
                Call SendData(ToMap, 0, Map, "TW" & 115)
            ...
            If Casa > 53 And Casa < 57 And UserList(i).flags.Paralizado = 0 Then
                Call SendData(ToIndex, i, 0, "|| Los Espiritus de la Casa te han Paralizado." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
                Call SendData(ToMap, 0, Map, "TW" & 115)
                Call SendData2(ToPCArea, i, UserList(i).Pos.Map, 22, UserList(i).Char.CharIndex & "," & 33 & "," & 1)
...
yupi:
            ...
            If ((UserList(i).Pos.Map > 14 And UserList(i).Pos.Map < 18) Or (UserList(i).Pos.Map > 20 And UserList( _
                                                                            i).Pos.Map < 22)) Then
...
alli:
            ...
            ElseIf UserList(i).Faccion.FuerzasCaos = 1 Then
            ...
            'If UserList(i).flags.ComproMacro > 0 Then
                ...
                'Call SendData(ToIndex, i, 0, "|| COMPROBANDO MACRO ASISTIDO: Debes Escribir /macro " & CodigoMacro & _
                                             " antes de " & UserList(i).flags.ComproMacro & " segundos." & "´" & _
                                             FontTypeNames.FONTTYPE_talk)
                ...
                'If UserList(i).flags.ComproMacro < 1 Then
                    ...
                    'Call SendData(ToGM, 0, 0, "||AntiMacro Cárcel para: " & UserList(i).Name & "´" & _
                                              FontTypeNames.FONTTYPE_talk)
            ...
            '¿Hay algun obj?
            If MapData(UserList(i).Pos.Map, UserList(i).Pos.X, UserList(i).Pos.Y).OBJInfo.ObjIndex > 0 And UserList( _
               i).flags.Muerto = 1 Then
...
errorHandlerNC:
    Call LogError("TCPServer:NuevaConexion " & Err.Description & " Newindex: " & NewIndex & " NextOpen: " & _
                  NextOpenUser & " ID: " & ID & " Loc: " & a)
...
Private Sub TCPServ_Read(ByVal ID As Long, _
                         Datos As Variant, _
                         ByVal Cantidad As Long, _
                         ByVal MiDato As Long)
    Dim t() As String
    Dim loopc As Long
    Dim RD As String
    'pluto:2.14
...
errorh:
    Call LogError("Error socket read: " & MiDato & " dato:" & RD & " userlogged: " & UserList( _
                  MiDato).flags.UserLogged & " connid:" & UserList(MiDato).ConnID & " ID Parametro" & ID & " error:" & _
                  Err.Description)
