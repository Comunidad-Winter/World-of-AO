...
noesq:
    ...
    ElseIf Hechizos(Spell).SubeHP = 2 Then
        ...
        If UserList(Userindex).Invent.AnilloEqpObjIndex > 0 Then
            If ObjData(UserList(Userindex).Invent.AnilloEqpObjIndex).SubTipo = 4 Then daño = daño - CInt(daño / 20)
...
Sub HechizoInvocacion(ByVal Userindex As Integer, ByRef b As Boolean)
    ...
    If UserList(Userindex).NroMacotas >= 3 Then Exit Sub
    'pluto:2.17
...
Sub HandleHechizoTerreno(ByVal Userindex As Integer, ByVal uh As Integer)
    ...
    If b Then
        ...
        Else
            UserList(Userindex).Stats.MinMAN = UserList(Userindex).Stats.MinMAN - Porcentaje(Hechizos( _
                                                                                             uh).ManaRequerido, 85)
...
Sub LanzarHechizo(index As Integer, Userindex As Integer)
    ...
    '  End If
    Dim DañoMag As Integer
    
    If UserList(Userindex).Invent.WeaponEqpObjIndex > 0 Then
    DañoMag = ObjData(UserList(Userindex).Invent.WeaponEqpObjIndex).Magia
    End If
    
    Debug.Print DañoMag & " Daño Magico"
    

    'Condiciones para lanzar Hechizos
     If DañoMag < 20 And UCase$(Hechizos(uh).Nombre) = UCase$("Llama de Dragon") Then
        Call SendData(ToIndex, Userindex, 0, "||Necesitas tener un Baculo mas poderoso lanzar LLama de Dragón." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If DañoMag < 20 And UCase$(Hechizos(uh).Nombre) = UCase$("Incinerar") Then
        Call SendData(ToIndex, Userindex, 0, "||Necesitas tener un Baculo mas poderoso lanzar Incinerar." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
              ...
              'Condiciones para lanzar Hechizos
     If DañoMag < 20 And UCase$(Hechizos(uh).Nombre) = UCase$("LLuvia de Sangre") Then
        Call SendData(ToIndex, Userindex, 0, "||Necesitas tener un Baculo mas poderoso lanzar LLuvia de Sangre." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
                   ...
                   'Condiciones para lanzar Hechizos
     If DañoMag < 20 And UCase$(Hechizos(uh).Nombre) = UCase$("Implosión") Then
        Call SendData(ToIndex, Userindex, 0, "||Necesitas tener un Baculo mas poderoso lanzar Implosión." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
    ...
    'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Invisibilidad") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes lanzar invisibilidad sobre usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Invisibilidad") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes lanzar invisibilidad sobre usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Remover Parálisis") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes Remover paralisis a usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Remover Parálisis") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes Remover paralisis a usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
              ...
              'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curar Heridas Críticas") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curar Heridas Críticas") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
                   ...
                   'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curación Divina") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curación Divina") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
                        ...
                        'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curacion Milagrosa") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Curacion Milagrosa") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
                             ...
                             'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Restauración") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Restauración") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes curar usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
                                  ...
                                  'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.ArmadaReal = 1 And Not UserList(TU).Faccion.ArmadaReal = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Resucitar") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes revivir usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
     ...
     End If
         ...
         'Condiciones para lanzar Hechizos
     If UserList(Userindex).Faccion.FuerzasCaos = 1 And Not UserList(TU).Faccion.FuerzasCaos = 1 And UCase$(Hechizos(uh).Nombre) = UCase$("Resucitar") Then
        Call SendData(ToIndex, Userindex, 0, "||No puedes revivir usuarios de otras facciones." & "´" & _
        FontTypeNames.FONTTYPE_INFO)
     Exit Sub
...
Sub HechizoPropNPC(ByVal hindex As Integer, _
    ...
    ElseIf Hechizos(hindex).SubeHP = 2 Then
        ...
        If Npclist(NpcIndex).NPCtype = 11 And UserList(Userindex).Faccion.FuerzasCaos = 1 Then
            Call SendData(ToIndex, Userindex, 0, "||No puedes atacar NPCs de tu mismo facción!!" & "´" & _
                                             FontTypeNames.FONTTYPE_INFO)
            Exit Sub
        End If
        ...
        If (EsMascotaCiudadano(NpcIndex, Userindex) Or Npclist(NpcIndex).NPCtype = NPCTYPE_GUARDIAS) Then
            ...
            'If UserList(Userindex).flags.Seguro = True Then
                Call SendData(ToIndex, Userindex, 0, "||No puedes atacar mascotas de la Alianza." & "´" & _
                                                     FontTypeNames.FONTTYPE_GUILD)
                Exit Sub
        ...
        End If
            ...
            'If UserList(Userindex).flags.Seguro = True Then
                Call SendData(ToIndex, Userindex, 0, "||No puedes atacar mascotas de la Horda." & "´" & _
                                                     FontTypeNames.FONTTYPE_GUILD)
                Exit Sub
...
Sub InfoHechizo(ByVal Userindex As Integer)
    ...
    If UserList(Userindex).flags.TargetUser > 0 Then
        ...
        Call SendData2(ToPCArea, Userindex, UserList(Userindex).Pos.Map, 76, UserList(UserList( _
                                                                                      Userindex).flags.TargetUser).Char.CharIndex & "," & H & "," & UserList(Userindex).Char.CharIndex)

    ElseIf UserList(Userindex).flags.TargetNpc > 0 Then

        Call SendData2(ToPCArea, Userindex, UserList(Userindex).Pos.Map, 76, Npclist(UserList( _
                                                                                     Userindex).flags.TargetNpc).Char.CharIndex & "," & H & "," & UserList(Userindex).Char.CharIndex)
    Else    'terreno
        Call SendData2(ToPCArea, Userindex, UserList(Userindex).Pos.Map, 76, UserList(Userindex).Char.CharIndex & "," _
                                                                             & H & "," & UserList(Userindex).Char.CharIndex)
    ...
    ElseIf UserList(Userindex).flags.TargetNpc > 0 Then
        Call SendData2(ToPCArea, Userindex, Npclist(UserList(Userindex).flags.TargetNpc).Pos.Map, 22, Npclist( _
                                                                                                      UserList(Userindex).flags.TargetNpc).Char.CharIndex & "," & Hechizos(H).FXgrh & "," & Hechizos( _
                                                                                                      H).loops)
...
noss:
    ...
    ElseIf Hechizos(H).SubeHP = 2 Then
        ...
        If UserList(tempChr).Invent.AnilloEqpObjIndex > 0 Then
            If ObjData(UserList(tempChr).Invent.AnilloEqpObjIndex).SubTipo = 4 Then daño = daño - CInt(daño / 20)
...
tuu:
        ...
        If UserList(tempChr).Stats.MinHP < UserList(tempChr).Stats.MaxHP / 3 And UserList(tempChr).raza = "Orco" Then
